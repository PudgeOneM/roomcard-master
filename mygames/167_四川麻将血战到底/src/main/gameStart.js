...
{   
    managerRes.startPreloadScene(g_resources, function () {
        ...
        cc.spriteFrameCache.addSpriteFrames(resp.winSortPlist, resp.winSortPng)
        ...
        t = new cc.SpriteFrame(resp.bg_dubo, cc.rect(0, 0, 169, 43))
        cc.spriteFrameCache.addSpriteFrame(t, "duboPic.png")
