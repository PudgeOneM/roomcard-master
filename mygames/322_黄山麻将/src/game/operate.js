...
var selectChi = 
{
	...
	setSelectInfo:function(cbInfoCount, info)
	{
		...
		for (var i = 0; i < cbInfoCount; i++) {
			...
			if (info[cbInfoCount-1-i].wActionMask & WIK_LEFT) 
			{
				selectChi.mj[i][0].spValue.setSpriteFrame('value_' + info[cbInfoCount-1-i].cbActionCard + '.png');
				selectChi.mj[i][0].spValue.color = cc.color(125, 125, 125);
				selectChi.mj[i][0].color = cc.color(125, 125, 125);
				selectChi.mj[i][1].spValue.setSpriteFrame('value_' + info[cbInfoCount-1-i].cbCardData[0] + '.png');
				selectChi.mj[i][1].spValue.color = cc.color(255, 255, 255);
				selectChi.mj[i][1].color = cc.color(255, 255, 255);
				selectChi.mj[i][2].spValue.setSpriteFrame('value_' + info[cbInfoCount-1-i].cbCardData[1] + '.png');
				selectChi.mj[i][2].spValue.color = cc.color(255, 255, 255);
				selectChi.mj[i][2].color = cc.color(255, 255, 255);
			}
			else if (info[cbInfoCount-1-i].wActionMask & WIK_CENTER) 
			{
				selectChi.mj[i][0].spValue.setSpriteFrame('value_' + info[cbInfoCount-1-i].cbCardData[0] + '.png');
				selectChi.mj[i][0].spValue.color = cc.color(255, 255, 255);
				selectChi.mj[i][0].color = cc.color(255, 255, 255);
				selectChi.mj[i][1].spValue.setSpriteFrame('value_' + info[cbInfoCount-1-i].cbActionCard + '.png');
			...
			else if (info[cbInfoCount-1-i].wActionMask & WIK_RIGHT) 
			{
				selectChi.mj[i][0].spValue.setSpriteFrame('value_' + info[cbInfoCount-1-i].cbCardData[0] + '.png');
				selectChi.mj[i][0].spValue.color = cc.color(255, 255, 255);
				selectChi.mj[i][0].color = cc.color(255, 255, 255);
				selectChi.mj[i][1].spValue.setSpriteFrame('value_' + info[cbInfoCount-1-i].cbCardData[1] + '.png');
				selectChi.mj[i][1].spValue.color = cc.color(255, 255, 255);
				selectChi.mj[i][1].color = cc.color(255, 255, 255);
				selectChi.mj[i][2].spValue.setSpriteFrame('value_' + info[cbInfoCount-1-i].cbActionCard + '.png');
			...
			selectChi.bg[i].wActionMask = info[cbInfoCount-1-i].wActionMask;
			selectChi.bg[i].cbCardData = [];
			selectChi.bg[i].cbCardData[0] = info[cbInfoCount-1-i].cbActionCard;
			selectChi.bg[i].cbCardData[1] = info[cbInfoCount-1-i].cbCardData[0];
			selectChi.bg[i].cbCardData[2] = info[cbInfoCount-1-i].cbCardData[1];
