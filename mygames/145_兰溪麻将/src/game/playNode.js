...
//     playNode.popGameEnd(null, ['诶我去无群二', '多撒多群多群大所', '大大大大法师的法师大大大大法师的法师', '大大舒服撒发生发我的'])
    ...
    {
        tableNode.ControlShow.setVisible(true)
    ...
    onCMD_StatusPlay:function() 
    {
        ...
        console.log(12312,clone(heapCardDatasArray), clone(cmdBaseWorker.cbHeapCardInfo), clone(cmdBaseWorker.TurnoverCard))
    ...
    onCMD_SendCard:function() 
    {
        ...
        playNode.iscontrol_1[cmdBaseWorker.wTakeCardUser] = INVALID_BYTE
        playNode.iscontrol_2[cmdBaseWorker.wTakeCardUser] = INVALID_BYTE
    ...
    onCMD_OperateResult:function() 
    {
        ...
        console.log(cmdBaseWorker.handcarddate[cmdBaseWorker.wOperateUser])
        playNode.timer.switchTimer(cmdBaseWorker.wCurrentUser==INVALID_WORD?[]:[tableData.getShowChairIdWithServerChairId(cmdBaseWorker.wCurrentUser)])
        ...
        console.log(playNode.iscontrol_1[cmdBaseWorker.wOperateUser])
        ...
        console.log(playNode.weaveMajiangs4D[cmdBaseWorker.wOperateUser])
        //var len = 0
        // for(var i in playNode.handMajiangs4D[cmdBaseWorker.wCurrentUser][0])
        // {
        //    // if(playNode.iscontrol_1[cmdBaseWorker.wCurrentUser] == playNode.handMajiangs4D[cmdBaseWorker.wCurrentUser][0][i])
        //    // {
        //         playNode.handMajiangs4D[cmdBaseWorker.wCurrentUser][0][i].color = cc.color(122,122,122)
        //        // len++
        //    // }
        // }
        // console.log(len)
        ...
        for(var showChairid=0;showChairid<4;showChairid++)
        {
            ...
            if(wChairID==cmdBaseWorker.wExitUser)
            {
                ...
                for(var i =0;i<4;i++)
                {
                    ...
                    control['winflag'+i].setSpriteFrame('empty.png')
                } 
            }
