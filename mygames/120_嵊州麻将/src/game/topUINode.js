...
{   
    ...
    {   
        ...
        typeSelNode.bindListener(topUINode.ModeBtnTable, topUINode.ModeBtnTableSel)
    },
    ModeBtnTableSel:function()
    {
        typeSelNode.btn_SelEnter.setVisible(false)
        typeSelNode.selBtnClose.setVisible(true)
        typeSelNode.isDealProcess = false
        typeSelNode.node.setVisible(true)
        typeSelNode.node.x = typeSelNode.nodeX
        typeSelNode.setGameType()
    },
