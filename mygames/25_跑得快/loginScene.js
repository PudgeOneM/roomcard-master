...
var loginScene = {
    ...
    login:function(d1,d2,d3)
    {
        ...
        var sip = '106.15.102.154:20240' //测试
        var sip = '106.15.102.154:20250'
        ...
        if(d3)
            ...
            llb_room = '{ "rtid":' + rtid + ', "server":"' + sip + '","options":{"name":"测试","endtime":3000,"takein":200,"canctrl":0, "lockowner":0}}'
