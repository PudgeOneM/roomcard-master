                    ...
                    {   
                        switch(tableData.CMD_GF_GameStatus.cbGameStatus)
                        {
                            case GAME_SCENE_FREE:
                            {
                                ...
                                {
                                    mainScene.onSubGameSetResult(body.bFanBei);
                                }
                                break;
                            }
        ...
        switch(head.CommandInfo.wMainCmdID)
        {
            case MDM_GF_GAME:       //游戏消息 200
            {
                switch(head.CommandInfo.wSubCmdID)
                {
                    ...
                    case SUB_S_FANBEI_RESULT:
                    {
                        var body = buffer2StructObj(msg.slice(8), 'CMD_S_FANBEI_RESULT');
                        return mainScene.onSubGameSetResult(body.bFanBei); 
                    }
                }
                break;
            }
