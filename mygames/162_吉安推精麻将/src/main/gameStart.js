...
{   
    managerRes.startPreloadScene(g_resources, function () {
        ...
        cc.spriteFrameCache.addSpriteFrames(resp.DiceNumberPlist, resp.DiceNumber)
        cc.spriteFrameCache.addSpriteFrames(resp.FlagOfGameEndPlist, resp.FlagOfGameEnd)
        cc.spriteFrameCache.addSpriteFrames(resp.GameSetPopResPlist, resp.GameSetPopRes)
