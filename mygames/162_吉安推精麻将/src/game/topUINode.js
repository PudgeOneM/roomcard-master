...
{   
    ...
    {   
        ...
        //model
        var modelMenu = new ccui.Button()
        modelMenu.loadTextures("modelMenu.png", "modelMenu.png", "modelMenu.png", ccui.Widget.PLIST_TEXTURE)
        modelMenu.addClickEventListener(function(btn)
            {
               playNode.clickViewSelectResult()
            });
        topUINode.modelNode.addChild(modelMenu)
