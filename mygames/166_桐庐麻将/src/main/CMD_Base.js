...
//游戏属性
var KIND_ID = 166								//游戏 I D
var GAME_NAME = "桐庐麻将"					//游戏名字
...
var CHR_QiDui = 0x00000040	//七对 任意花色的七个对子组成 
...
var CHR_QingHaoHuaQiDui = 0x00001000	//清豪华七对 牌里包含3张财神（不可吃冲、可自摸）  
var CHR_GangKai = 0x00002000	//杠上开花（杠开）    开杠抓进的牌成和牌   
var CHR_QingQiDui = 0x00004000	//清七对  和别人自抓开明杠的牌  
var CHR_WuCaiShen = 0x00008000	//无财
var CHR_QingErHaoHuaQiDui = 0x00010000	//清二豪华七对 庄家出第一张点炮下家和是地和，牌型不限。  
var CHR_QingSanHaoHuaQiDui = 0x00020000	//清三豪华七对 不管什么牌型，最后成单调的都算特殊牌型。
...
[
	...
	['WORD', 'wForbidActionUser', 2],//只记录两个玩家即可，因为两个玩家打财神，全场没有吃碰与点炮杠
	['BYTE', 'cbSiceCount', 4],
