...
/*****************************///录像
        this.inputBox4 = new cc.Node()
        this.inputBox4.setContentSize(200, 70)
        this.inputBox4.setPosition(500, 300)
        this.ui.addChild(this.inputBox4)

        this.inputBox5 = new cc.Node()
        this.inputBox5.setContentSize(200, 70)
        this.inputBox5.setPosition(500, 200)
        this.ui.addChild(this.inputBox5)

        createNameEditBox(this.inputBox4,'openId', null, cc.color(255, 255, 255, 255))
        createNameEditBox(this.inputBox5,'videoNum', null, cc.color(255, 255, 255, 255))
/******************************/
    ...
    {   
        ...
        {    
            //loginScene.login(this.inputBox1.data, this.inputBox2.data, this.inputBox3.data)//录像
            loginScene.login(this.inputBox1.data, this.inputBox2.data, this.inputBox3.data, this.inputBox4.data, this.inputBox5.data)
        }
    },
    login:function(d1,d2,d3,d4,d5)
    {
        //var sip = '121.199.40.69:23060' //正式
        //var sip = '106.15.102.154:20020' //测试
        var sip = '192.168.2.144:21310'
        var rtid = 13
       // var sip = '106.15.102.154:20020'
       var sip = '106.15.102.154:21310'
        ...
        {
            d5 = d5 || 1
            llb_room = '{ "rtid":' + rtid + ', "server":"'+ sip + '"}'
            llb_replay.VideoId = d4  
            llb_replay.VideoNum = d5
        }
        else if(d3)
            llb_room = '{ "rtid":' + rtid + ', "server":"'+ sip + '","roomkey": "' + d3 + '"}'
        else
            llb_room = '{ "rtid":' + rtid + ', "server":"' + sip + '","options":{"name":"测试","endtime":20000,"takein":200,"canctrl":0, "lockowner":0}}'
