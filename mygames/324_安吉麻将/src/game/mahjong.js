...
var disCardControl = 
{
	...
	setControlPos:function(wChaird)
	{
		...
		switch(wChaird)
		{
			...
			fy = handMahJong.control[0].y + handMahJong.control[0].height/2 + 15 + disCardControl.control[wChaird][i].height/2+40;
...
var weaveControl = 
{
	...
	addWeaveItem:function(wChaird, cbWeaveIndex, cbCardData, cbCardCount, visible)
	{
 		...
 		if (visible)
 		{
	 		...
	 		weaveControl.arrow[wChaird][cbWeaveIndex].visible = false;
