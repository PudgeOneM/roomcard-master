...
{   
    ...
    cbEatPengCargData1:null,
    cbEatPengCargData2:null,
    cbAutocard:[],
    cbAutocardUser:[],
    cblaozhuang:null,
    init:function()
    ...
    onReStart:function()
    {
        ...
        cmdBaseWorker.cbEatPengCargData1 = INVALID_WORD
        cmdBaseWorker.cbEatPengCargData2 = INVALID_WORD
        cmdBaseWorker.cblaozhuang = null
    },
    ...
    {	
        cmdBaseWorker.cbAutocardUser = body.cbAutocardUser
        cmdBaseWorker.cbEatPengCargData1 = body.cbEatPengCargData1
        cmdBaseWorker.cbEatPengCargData2 = body.cbEatPengCargData2
        ...
        cmdBaseWorker.cbLeftCardCount = body.cbLeftCardCount -20
    ...
    onCMD_GameStart:function(body) 
    {
        ...
        cmdBaseWorker.cbOutCardCount = 0  
        cmdBaseWorker.dicerandom1 = body.dicerandom1
        cmdBaseWorker.dicerandom2 = body.dicerandom2
    ...
    {
        cmdBaseWorker.cbAutocard = body.cbAutocard
        cmdBaseWorker.cbAutocardUser = body.cbAutocardUser
        cmdBaseWorker.cbActionMask    = body.cbActionMask   
...
console.log(body.cbProvideCardData   )
    ...
    onCMD_OperateResult:function(body) 
    {
        ...
        console.log(cmdBaseWorker.cbActionMask )
    ...
    {
console.log(8888,clone(body))
        cmdBaseWorker.cblaozhuang     = body.cblianzhuang
        
        console.log(cmdBaseWorker.cblaozhuang )
    ...
    searchGangIdxs:function(handMajiangs, weaveMajiangs) //自摸杠时找到杠哪个 服务器传? TODO
    {
        ...
        for(var i=0;i<handIdxs.length;i++)
        {
            ...
            if(i>0 && idx == handIdxs[i-1])
                continue
            console.log(cmdBaseWorker.isMagicCard(idx, cmdBaseWorker.cbMagicCardData))
            var isHas = majiangLogic.isHas(handIdxs, [], [idx, idx, idx, idx])
            if(isHas[0]&&(!cmdBaseWorker.isMagicCard(idx, cmdBaseWorker.cbMagicCardData)))
