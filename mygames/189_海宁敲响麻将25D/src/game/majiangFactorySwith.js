...
majiangFactory._gethandMajiangsListener = function(majiangs, parent, touchEndCall)
{
    ...
    {      
        ...
        for(var i=0;i<majiangs[0].length;i++)
        {
            ...
            {
                juli_1 = majiangs[0][i].getPosition().x
                juli_2 = majiangs[0][i].getPosition().y
                return mj
            }
        }
    ...
    var listener = cc.EventListener.create({
        ...
        onTouchEnded: function (touch, event) {
            ...
            if(currentMajiang)
            {
                if((touchedMjNum == 1 && isTouchFromPop) || (ismoved && Hmove >100))
                {
                    /***************滑动出牌**********/
                ...
                else
                {
                    ...
                    currentPopMajiang.y = mjOriginY+20
                    /***************滑动出牌**********/
                    Hmove = null
                }
            }
