...
{   
    ...
    onReStart:function()
    {
        cmdBaseWorker.sendCardAnGang = [[],[],[],[]]
        cmdBaseWorker.m_lGameScore2Name = []
        cmdBaseWorker.cbListenState = []
        cmdBaseWorker.showListenCardData = [[],[],[],[],[],[],[],[],[],[],[],[],[],[]]
        cmdBaseWorker.cbListenCardData = [[],[],[],[]]
        cmdBaseWorker.cbOperateListenCardData = [[],[],[],[]]
    ...
    onCMD_StatusPlay:function(body) 
    {
        ...
        //新加
        cmdBaseWorker.showListenCardData = body.m_cbListenShowCardData
        cmdBaseWorker.cbListenCardData = body.m_cbListenCardData
        cmdBaseWorker.sendCardAnGang = body.sendCardAnGang
        cmdBaseWorker.cbListenState = body.wListenState
        cmdBaseWorker.cbOperateListenCardData = body.cbOperateListenCardData
    ...
    {
        cmdBaseWorker.sendCardAnGang = body.sendCardAnGang
        cmdBaseWorker.showListenCardData = body.showListenCardData
        cmdBaseWorker.cbActionMask    = body.cbActionMask   
        cmdBaseWorker.wProvideUser    = body.wProvideUser   
        cmdBaseWorker.cbProvideCardData  = body.cbProvideCardData    
        cmdBaseWorker.wCurrentUser = body.wCurrentUser
    ...
    onCMD_GameEnd:function(body) 
    {
        ...
        cmdBaseWorker.m_lGameScore2Name = body.m_lGameScore2Name
