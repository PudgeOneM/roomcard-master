...
//游戏属性
var KIND_ID = 133								//游戏 I D
var GAME_NAME = "宿州麻将"					//游戏名字
...
//其他
var MAX_SEND_COUNT = 24//摸到所有花补花 要发一样多的牌 MAX_FLOWER_COUNT											
var MAX_OPERATE_COUNT = 24//客户端执行动作时发给服务器的麻将最大数 如果有补花操作 可能出现摸到所有花补花 MAX_FLOWER_COUNT		
...
var CHR_ZiMoGangCi = 0x00000008	//碰碰胡 由任意花色及风字组成的碰胡   
...
[
	['BYTE', 'cbOperateListenCardData', GAME_PLAYER, MAX_COUNT],
	['BYTE', 'sendCardAnGang', GAME_PLAYER, MAX_WEAVE],       //暗杠要展示的牌
	['BYTE', 'showListenCardData', MAX_COUNT, MAX_INDEX],
...
[
	...
	//新加的变量
	['BYTE', 'm_cbListenCardData', GAME_PLAYER, MAX_INDEX],
	['BYTE', 'cbOperateListenCardData', GAME_PLAYER, MAX_COUNT],
	['BYTE', 'm_cbListenShowCardData', MAX_COUNT, MAX_INDEX],
	['BYTE', 'sendCardAnGang', GAME_PLAYER, MAX_WEAVE],      //暗杠要展示的牌
    ['BYTE', 'wListenState', GAME_PLAYER],
