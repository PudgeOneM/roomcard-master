...
{   
    ...
    onCMD_StatusFree:function() 
    {
        ...
        if(tableData.isCreateTable)
        {
            ...
            {
                // tableNode.maiMaText.setPositionX(playNode.scoreTTF.getPositionX() + 50)
                // tableNode.youGuiText.setPositionX(tableNode.maiMaText.getPositionX() + 47)
    ...
    {
        // tableNode.maiMaText.setPositionX(playNode.scoreTTF.getPositionX() + 50)
        // tableNode.youGuiText.setPositionX(tableNode.maiMaText.getPositionX() + 42)
        tableNode.maiMaText.setString((cmdBaseWorker.maFen + "马"))
        tableNode.youGuiText.setString(cmdBaseWorker.isFanGui?"翻鬼":"无鬼")
    },
