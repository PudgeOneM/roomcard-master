...
{   
    ...
    { 
        ...
        topUINode.havecai = function()
        {
            var MoShi = getObjWithStructName('CMD_C_ChooseMoshi')
            MoShi.cbchoose = 0
            topUINode.MoShi.setVisible(false)
            socket.sendMessage(MDM_GF_GAME,SUB_C_Choose_Moshi,MoShi)
            topUINode.control = 1
        }
        topUINode.Nocai = function()
        {
            var MoShi = getObjWithStructName('CMD_C_ChooseMoshi')
            MoShi.cbchoose = 1
            socket.sendMessage(MDM_GF_GAME,SUB_C_Choose_Moshi,MoShi)
