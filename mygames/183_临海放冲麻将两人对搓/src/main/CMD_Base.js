...
//游戏属性
var KIND_ID = 183								//游戏 I D
var GAME_NAME = "临海放冲麻将两人对搓"	//游戏名字
...
var START_MODE = START_MODE_ALL_READY //麻将模式的选择
///////////////游戏配置 begin////////////
...
var CHR_PaoCaiShen = 0x00000004	//跑财神 海底捞月 算特殊牌型，即最后一个玩家抓最后一张牌时胡牌，那么就称之为海底捞月。
...
var CHR_QuanFengZi = 0x00000100	//全风字
var CHR_ZhuoChong = 0x00000200	//捉冲 任意花色的七个对子组成 
...
[
	['WORD', 'wCallUser'],						
	['BYTE', 'cbCallRecord', GAME_PLAYER2, 2],			//叫分信息
	['WORD', 'wCurrentUserCall'],						//当前玩家				
]
...
[
	...
	['WORD', 'wHeapHead'],							//堆立头部
	['WORD', 'wHeapTail'],							//堆立尾部
	['BYTE', 'cbHeapCardInfo', GAME_PLAYER2, 2],					//堆牌信息
	['heapCardItem', 'TurnoverCard', max(1,TURNOVER_COUNT_MAGIC)],

	['BYTE', 'cbCallRecord', GAME_PLAYER2, 2],//下跑 加顶分
]
...
[	
	...
	['WORD', 'wProvideUser'],						//供应用户
	['BYTE', 'cbProvideCardData'],						//供应扑克
	['WORD', 'wCurrentUser'],						//当前出牌用户 碰杠会有可能进入动作状
...
[
	...
	['WORD', 'wProvideUser'],						//供应用户
	['BYTE', 'cbProvideCardData'],						//供应扑克
	['DWORD', 'dwChiHuKind', GAME_PLAYER2],			//胡牌类型
	['DWORD', 'dwChiHuRight', GAME_PLAYER2],			//胡牌类型
	['LONGLONG', 'lGameTaiCount', GAME_PLAYER2],			
	['LONGLONG', 'lGameScore', GAME_PLAYER2],			//游戏积分
	['BYTE', 'cbHandCardCount', GAME_PLAYER2],			//扑克数目
	['BYTE', 'cbHandCardData', GAME_PLAYER2, MAX_COUNT],	//扑克数据
	['BYTE', 'cbWeaveCount', GAME_PLAYER2],					//组合数目
	['tagWeaveItem', 'WeaveItemArray', GAME_PLAYER2, MAX_WEAVE],		//组合扑克
	['BYTE', 'cbGangScorecard', 6],
	['BYTE', 'cbScoreData', GAME_PLAYER2, 6],
]
...
[
	...
	['BYTE', 'cbOutCardData'],								//出牌扑克
	['BYTE', 'cbDiscardCount', GAME_PLAYER2],				//丢弃数目
	['BYTE', 'cbDiscardCardData', GAME_PLAYER2, 60],				//丢弃记录
	...
	['BYTE', 'cbPlayerFlowerCount', GAME_PLAYER2],			//丢弃花牌数目
	['BYTE', 'cbPlayerFlowerCardData', GAME_PLAYER2, max(1,MAX_FLOWER_COUNT)],		//丢弃花牌记录
