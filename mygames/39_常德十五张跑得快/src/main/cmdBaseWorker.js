...
{   
    ...
    onReStart:function()
    {
        ...
        cmdBaseWorker.outCardType = {}
    },
    onCMD_StatusFree:function(body) 
    {
        cmdBaseWorker.lCellScore = body.lCellScore
        cmdBaseWorker.cbNiaoCard = body.cbNiaoCard
        cmdBaseWorker.bRandCard = body.bRandCard
    },
    ...
    onCMD_GameStart:function(body) 
    {
        ...
        cmdBaseWorker.wOutCardUser = INVALID_WORD
        cmdBaseWorker.outCardType = { cbType:CT_ERROR, cbLogicValue:0, cbLength:0 }
    },
