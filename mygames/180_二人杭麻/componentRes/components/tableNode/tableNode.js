...
{   
    ...
    {   
        ...
        var t = new cc.SpriteFrame(resp + 'style' + styleId + '_bg.jpg', cc.rect(0, 0, 960, 640))
        cc.spriteFrameCache.addSpriteFrame(t, 'style' + styleId + '_bg.jpg')
        ...
        {
            res[i] = resp + 'style' + styleIdLast[i] + '_bg.jpg'
        }
        cc.loader.load(res,
           ...
           {    
                for(var i=0;i<styleIdLast.length;i++)
                {
                    var t = new cc.SpriteFrame(resp + 'style' + styleIdLast[i] + '_bg.jpg', cc.rect(0, 0, 960, 640))
                    cc.spriteFrameCache.addSpriteFrame(t, 'style' + styleIdLast[i] + '_bg.jpg')
                } 
           })
    },
    onReStart:function()
    ...
    {	
        ...
        //style
        var styleId = styleArray[1]
        tableNode.bgSpr = new cc.Sprite( '#style' + styleId + '_bg.jpg' )
        tableNode.bgSpr.x = tableNode.node.width*0.5
        tableNode.bgSpr.y = tableNode.node.height*0.5
        ...
        {   
            var styleId = styleArray[1]
            var frameName = 'style' + styleId + '_bg.jpg'
