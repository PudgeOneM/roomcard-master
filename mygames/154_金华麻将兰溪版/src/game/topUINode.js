...
{   
    ...
    { 
        ...
        topUINode.difen_0 = function()
        {
            var MoShi = getObjWithStructName('CMD_C_OnMoShiEvent')
            MoShi.wtype = 0
            topUINode.button.setVisible(false)
            socket.sendMessage(MDM_GF_GAME,SUB_C_ModerChose,MoShi)
        }
        topUINode.difen_1 = function()
        {
            var MoShi = getObjWithStructName('CMD_C_OnMoShiEvent')
            MoShi.wtype = 1
            topUINode.button.setVisible(false)
