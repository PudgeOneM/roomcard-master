...
//游戏属性
var KIND_ID = 35									//游戏 I D
var GAME_NAME = "火拼双扣"					//游戏名字
...
var TURNOVER_COUNT_FRIEND = 1   //组队时要翻的牌
var MAX_BOOM_BIG_NUM_COUNT = 7 //大于五星炸弹的炸弹种类个数
var CARD_PARSER_LENGTH = 20
...
var SUB_S_CHAIR_CHANGE = 109                                 //切换椅子



var CMD_S_ChairChange = 
[
	['WORD', 'wNewChairID', GAME_PLAYER],
]
...
// 	['BYTE', 'cbHandCardDataSelf', MAX_COUNT],			//扑克列表
	['WORD', 'wFriendUser', GAME_PLAYER],
	['WORD', 'wNewGamePlayeIndex', GAME_PLAYER],
	['BYTE', 'cbShowCardData'],
	['WORD', 'wBankerUser'],
]
...
[
	...
	['BYTE', 'cbOutCardScore'],
	['LONG', 'lOperateScore', GAME_PLAYER, 3],
...
[
	['WORD', 'wExitUser'],						//强退用户
	['LONG', 'lShowGameScore', GAME_PLAYER],			//游戏积分
	['LONG', 'lGameScore', GAME_PLAYER],
    ['BYTE', 'cbWinType', GAME_PLAYER],
	...
	['BYTE', 'cbOutBombCount', GAME_PLAYER, MAX_BOOM_BIG_NUM_COUNT],
	['LONG', 'lOperateScore', GAME_PLAYER, 3],
...
var SUB_C_PLAYER_ORDER = 5                    //用户出牌顺序
...
var CMD_C_ORDER = 
[
	['WORD', 'wNewGamePlayer', GAME_PLAYER],
]
//////////////////////////////////////////////////////////////////////////
