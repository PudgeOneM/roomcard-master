...
var loginScene = {
    ...
    login:function(d1,d2,d3)
    {
        ...
        var sip = '192.168.2.111:21100'
        var rtid = 13
       var sip = '106.15.102.154:21100'

        var uid = d1 || 17
        //var token = '{"wxid":"wx209f61ea8dd0e477","opid":"oLuUOxB9WGm200tnaw98biU67CcA","uid":'+ uid +',"exp":1570024000}'
        
        var token = '{"wxid":"wx209f61ea8dd0e477","opid":"oLuUOxB9WGm200tnaw98biU67CcA","uid":'+ uid +',"exp":' + (Math.floor(new Date().getTime()/1000) + 360000) + '}'
