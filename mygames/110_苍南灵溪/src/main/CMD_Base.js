...
//游戏属性
var KIND_ID = 110								//游戏 I D
var GAME_NAME = "苍南灵溪麻将"					//游戏名字
...
//财神
var MAX_MAGIC_COUNT = 8//无财神时设置为1 m_cbMagicIndex[MAX_MAGIC_COUNT]不赋值即可
var TURNOVER_COUNT_MAGIC = 2//无财神时设置为1 翻财神时翻的麻将数 		
...
var CHR_CaiShenHui = 0x00000010	//财神汇  
var CHR_ZiMo = 0x00000020	//自摸
var CHR_YingDaYing = 0x00000040	//硬打硬 
var CHR_DDJYuCai = 0x00000080	//单吊将(财) 
var CHR_DDJFeiCai = 0x00000100	//单吊将(非财)    
var CHR_SiFengQi = 0x00000200	//四风齐 
...
[
	...
	['BYTE', 'cbBuGangStatus'],						//是否补杠
]

//发送扑克
var CMD_S_SendCard = 
[
	['BYTE', 'cbCanOutMagic'],						//是否可出花
	['BYTE', 'cbBuGangStatus'],						//是否补杠
	['BYTE', 'cbActionMask'],						//动作掩码
	['WORD', 'wProvideUser'],						//供应用户
