...
{   
    ...
    onReStart:function()
    {
        ...
        cmdBaseWorker.cbBuGangStatus    = 0
        cmdBaseWorker.cbCanOutMagic     = 0
    ...
    {	
        cmdBaseWorker.cbCanOutMagic   = body.cbCanOutMagic
        ...
        cmdBaseWorker.cbBuGangStatus  = body.cbBuGangStatus   
        ...
        {   
            ...
            cmdBaseWorker.cbPlayerFlowerCardData[showChairId]  = body.cbPlayerFlowerCardData[i].slice(0, body.cbPlayerFlowerCount[i])  
        }
    ...
    {        
        ...
        cmdBaseWorker.cbOutCardCount = 0  
        cmdBaseWorker.cbEndLeftCount    = 20
    ...
    searchGangIdxs:function(handMajiangs, weaveMajiangs) //自摸杠时找到杠哪个 服务器传? TODO
    {
        ...
        for(var i=0;i<weaveMajiangs.length;i++)
        {
            ...
            if(majiangsOneGroup.cbWeaveKind == WIK_PENG && !isChiPeng ) //吃碰后不允许补杠
