...
var locationPop = 
{
    ...
    preLoadRes:
    [
        'components/locationPop/res/locationPop.plist', 
        'components/locationPop/res/locationPop.png'
    ],
    ...
    {  
        ...
        var l = cc.EventListener.create({
            ...
            {   
                ...
                var users = []
                for(var direction=0;direction<GAME_PLAYER;direction++)
                {
                ...
                for(var direction1=0;direction1<GAME_PLAYER;direction1++)
                {
                    for(var direction2=direction1+1;direction2<GAME_PLAYER;direction2++)
                    {
