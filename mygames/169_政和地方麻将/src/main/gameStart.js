...
{   
    managerRes.startPreloadScene(g_resources, function () {
        ...
        cc.spriteFrameCache.addSpriteFrames(resp.warningResPlist, resp.warningRes)
        cc.spriteFrameCache.addSpriteFrames(resp.chiHuTypeRecordPlist, resp.chiHuTypeRecord)
        cc.spriteFrameCache.addSpriteFrames(resp.chiHuTypeResPlist, resp.chiHuTypeRes)
        cc.spriteFrameCache.addSpriteFrames(resp.chiHuTypeImgPlist, resp.chiHuTypeImg)
        ...
        t = new cc.SpriteFrame('gameRes/pic/res/chatBg1.png', cc.rect(0, 0, 2, 2))
        cc.spriteFrameCache.addSpriteFrame(t, "chatBg1.png")
        t = new cc.SpriteFrame('gameRes/pic/res/chatBg2.png', cc.rect(0, 0, 2, 2))
        cc.spriteFrameCache.addSpriteFrame(t, "chatBg2.png")
