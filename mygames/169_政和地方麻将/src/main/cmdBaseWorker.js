...
{   
    ...
    cbForbidOutData:null,

    //政和
    wHCurrentUser:INVALID_WORD,
    wHProUser:INVALID_WORD,
    cbHActionMask:null,
    cbFirstRound:1,
    cbNextZhuangCount:0,
    bIsNeedChengBao:false,
    wHTakeCardUser:INVALID_WORD,
    bIsWarningQYS:false,
    wWarningUser:null,
    cbMaxRightType:null,
    bComplexHuType:[false, false, false],
    ...
    onReStart:function()
    {
        ...
        /////////////////以下是政和规则/////////////////////
        cmdBaseWorker.cbForbidOutData     = null
        cmdBaseWorker.wHCurrentUser       = INVALID_WORD
        cmdBaseWorker.wHProUser           = INVALID_WORD
        cmdBaseWorker.cbHActionMask       = null
        cmdBaseWorker.cbFirstRound        = 1
        cmdBaseWorker.cbNextZhuangCount   = 0
        cmdBaseWorker.bIsNeedChengBao     = false
        cmdBaseWorker.wHTakeCardUser      = INVALID_WORD
        cmdBaseWorker.dwHBankerUserId     = INVALID_WORD
        cmdBaseWorker.bIsWarningQYS       = false
        cmdBaseWorker.wWarningUser        = null
        cmdBaseWorker.cbMaxRightType      = null
        cmdBaseWorker.bComplexHuType      = [false, false, false]
        cmdBaseWorker.bmyselfGameEndtype  = false
        cmdBaseWorker.bIsGangAnOrMn       = 0
    },
    ...
    {	
        ...
        //////////////////////以下是政和规则///////////////////////
        cmdBaseWorker.cbForbidOutData       = body.cbForbidOutData
        cmdBaseWorker.cbFirstRound          = body.cbFirstRound
        cmdBaseWorker.bIsWarningQYS         = body.bIsWarningQYS
        cmdBaseWorker.wWarningUser          = body.wWarningUser
        cmdBaseWorker.cbMaxRightType        = body.cbMaxRightType
        cmdBaseWorker.bComplexHuType        = [false, false, false]
        cmdBaseWorker.bmyselfGameEndtype    = false
        cmdBaseWorker.bIsGangAnOrMn         = 0
    ...
    onCMD_GameStart:function(body) 
    {
        ...
        for(var i=0;i<GAME_PLAYER;i++)
        {
            ...
            // {
            //     cmdBaseWorker.cbHandCardData[i][j] = isSelf?body.cbHandCardData[i][j]:0
            // }
            for(var j=0;j<MAX_COUNT-1;j++)
            {
    ...
    onCMD_OutCard:function(body)
    {
        ...
        cmdBaseWorker.cbMaxRightType        = body.cbMaxRightType
        cmdBaseWorker.bIsGangAnOrMn         = 0
    //     if(cmdBaseWorker.cbFirstRound) //11.10弃用
    //         cmdBaseWorker.wProvideUser = cmdBaseWorker.wHProUser
    },
    ...
    onCMD_FirstRound:function(body)
    {
        cmdBaseWorker.wHCurrentUser       = body.wHCurrentUser
        cmdBaseWorker.cbHActionMask       = body.cbHActionMask
        cmdBaseWorker.wHProUser           = body.wHProUser

        cmdBaseWorker.wCurrentUser = cmdBaseWorker.wHCurrentUser
        cmdBaseWorker.wProvideUser = cmdBaseWorker.wHProUser
    },
    ...
    onCMD_OperateResult:function(body) 
    {
        ...
        cmdBaseWorker.bIsWarningQYS        = body.bIsWarningQYS
        cmdBaseWorker.wWarningUser         = body.wWarningUser
        cmdBaseWorker.bIsGangAnOrMn        = body.bIsGangAnOrMn
    },
    onCMD_GameEnd:function(body) 
    {
        ...
        //////////////////////以下是政和规则///////////////////////
        cmdBaseWorker.cbForbidOutData   = body.cbForbidOutData
        cmdBaseWorker.cbNextZhuangCount = body.cbNextZhuangCount
        cmdBaseWorker.bIsNeedChengBao   = body.bIsNeedChengBao
        cmdBaseWorker.wWarningUser      = body.wWarningUser
        cmdBaseWorker.cbMaxRightType    = body.cbMaxRightType
        cmdBaseWorker.bComplexHuType    = body.bComplexHuType
