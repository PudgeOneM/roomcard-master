var gameClock = 
{
	...
	setClockInfo:function()
	{
		...
		var angle = 180*((GAME_PLAYER-(mainScene._wBankerUser-wMeChaird))%GAME_PLAYER);
	...
	setGameClock:function(wChaird)
	{
		...
		{
			var wMeChaird = mainScene._wMeChaird == INVALID_CHAIR ? 0:mainScene._wMeChaird;
			var angle = 180*((GAME_PLAYER-(wChaird-wMeChaird))%GAME_PLAYER);
			...
			var dct = (wChaird == mainScene._wBankerUser)?0:2;
