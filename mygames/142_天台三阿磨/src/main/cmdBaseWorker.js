...
{   
    ...
    cbEndLeftCount:null,
    cbFengPos:null,
    cbWeaveGangType:null,
    IGameScoreRe:null,
    cbPlayType:null,

    cbDiHuScore:null,          //底胡分数
    cbHuaScore:null,           //花牌分数
    cbHuaFan:null,             //花牌番数
    cbKeScore:null,            //刻子分数
    cbGangScore:null,          //杠牌分数
    cbPengScore:null,          //碰牌分数
    cbDuiZiScore:null,         //对子分数
    cbTotolScore:null,         //总分数
    ...
    onReStart:function()
    {
        ...
        cmdBaseWorker.wSelectUser       = INVALID_WORD
       // cmdBaseWorker.cbPlayType        = null
        //cmdBaseWorker.cbEndLeftCount    = 0

    },
    onCMD_UpdataData:function(body){
        cmdBaseWorker.wCurrentUser = body.wCurrentUser
    },
    onCMD_SelectMoPai:function(body)
    {
        cmdBaseWorker.wSelectUser   = body.wCurrentUser
    ...
    {	
        ...
        cmdBaseWorker.wSelectUser     = body.wSelectUser
        cmdBaseWorker.wBankerUser     = tableData.getUserWithUserId(body.dwBankerUserId).wChairID   
        cmdBaseWorker.lCellScore      = body.lCellScore      
        cmdBaseWorker.wCurrentUser    = body.wCurrentUser    
        cmdBaseWorker.cbFengPos       = body.cbFengPos
        cmdBaseWorker.cbLeftCardCount = body.cbLeftCardCount 
        cmdBaseWorker.cbEndLeftCount  = body.cbEndLeftCount
        ...
        cmdBaseWorker.cbWeaveGangType  = body.cbWeaveGangType    
    ...
    onCMD_GameEnd:function(body) 
    {
        ...
        cmdBaseWorker.dwChiHuAssist   = body.dwChiHuAssist
        cmdBaseWorker.lGameScore      = body.lGameScore
        cmdBaseWorker.IGameScoreRe    = body.IGameScoreRe
        cmdBaseWorker.cbHandCardCount = body.cbHandCardCount
        ...
        cmdBaseWorker.cbDiHuScore   = body.cbDiHuScore          
        cmdBaseWorker.cbHuaScore    = body.cbHuaScore           
        cmdBaseWorker.cbHuaFan      = body.cbHuaFan   
        cmdBaseWorker.cbKeScore     = body.cbKeScore    
        cmdBaseWorker.cbGangScore   = body.cbGangScore
        cmdBaseWorker.cbPengScore   = body.cbPengScore
        cmdBaseWorker.cbDuiZiScore  = body.cbDuiZiScore
        cmdBaseWorker.cbTotolScore  = body.cbTotolScore
