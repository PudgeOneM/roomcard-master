...
var handMahJong = {
    ...
    {   
        var listener = cc.EventListener.create({
           ...
           onTouchBegan: function (touch, event) {
           		if(mainScene._bDingCSEnd == false) return false;
	...
	showMagicCard:function(bstate,bSort)
	{
		if(bSort==true)
		{
			handMahJong.handDataExcEx(" showMagicCard1: ", handMahJong.cbCardData, handMahJong.cbCardCount);
			mainScene.sortHandCard(handMahJong.cbCardData);
			handMahJong.handDataExcEx(" showMagicCard2: ", handMahJong.cbCardData, handMahJong.cbCardCount);
