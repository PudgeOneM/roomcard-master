...
var loginScene = {
    ...
    {   
        ...
        {    
            ...
            loginScene.login(this.inputBox1.data, this.inputBox2.data, this.inputBox3.data, this.inputBox4.data, this.inputBox5.data)   //录像功能  结构修改
        }
    },
    login:function(d1,d2,d3,d4,d5)
    {
        ...
        var sip = '192.168.2.126:21300'
        var rtid = 13
        //var sip = '106.15.102.154:20020'
        //var sip = '106.15.102.154:21300'
