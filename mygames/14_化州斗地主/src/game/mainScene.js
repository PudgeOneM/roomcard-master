...
var mainScene = {
    runThisScene:function(callAfterRun)
    {
        ...
        tableNode.init(resp.tableCCB, mainScene.adjustAfterLoad)
    ...
    {  
        ...
        var l = cc.EventListener.create({
            ...
            {   
                ...
                {
                    currentRoundNode.handCards.setPosition( cc.p(0, 0) )
                    currentRoundNode.outCards.setPosition( cc.p(0, 160) )
                    currentRoundNode.scoreChange.setPosition( cc.p(0, 80) )
                    currentRoundNode.tipsSpr.setPosition( cc.p(0, 150) )
                }
                else
                {       
                    ...
                    currentRoundNode.tipsSpr.setPosition( cc.p(-50 * sign, 0) )
    ...
    adjustAfterLoad:function()
    {
        tableNode.chairNode0.y = 90
    }
}
