...
//游戏属性
var KIND_ID = 343									//游戏 I D
var GAME_NAME = "二人象山麻将"					//游戏名字
...
var tagTingItem = 
[
	['BYTE', 'cbOutCard'],							//打出此张牌后听牌
	['BYTE', 'cbTingKouCount'],						//听口张数
	['BYTE', 'cbTingKou', MAX_COUNT],				//听口
	['BYTE', 'cbFanShu', MAX_COUNT],				//每张听口听得番数
]
//////////////////////////////////////////////////////////////////////////
//服务器命令结构
...
var SUB_S_LISTEN_NOTIFY	= 109									//听牌提示
...
[
	...
	['bool', 'bListenStatus'],
	['BYTE', 'cbListenOutCard'],						//出牌扑克
	['BYTE', 'cbGangData', MAX_WEAVE],
	['BYTE', 'cbTingCount'],						//听牌数目
	['tagTingItem', 'tingItem', MAX_COUNT],			//听牌数据
]
...
//听牌提示
var CMD_S_ListenNotify = 
[
	['BYTE', 'cbActionMask'],						//动作掩码
	['BYTE', 'cbTingCount'],
	['tagTingItem', 'tingItem', MAX_COUNT],
]
