...
{   
    ...
    managerRes.startPreloadScene(g_resources, function () {
        ...
        cc.spriteFrameCache.addSpriteFrames(resp.animationRePlist, resp.animationRe)
        cc.spriteFrameCache.addSpriteFrames(resp.repalceCardResPlist, resp.repalceCardRes)
        ...
        myFacePoP.PreLoadResOnMyfacePop()
        //动画资源异步加载
        var res = 
        [
