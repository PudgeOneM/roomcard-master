...
{
    var weaveItems = []
    if((cmdBaseWorker.cbActionMask & WIK_RIGHT) != 0)
    {
    ...
    if((cmdBaseWorker.cbActionMask & WIK_CENTER) != 0)  
    {
    ...
    if((cmdBaseWorker.cbActionMask & WIK_LEFT) != 0)
    {
...
//     if( !gameLogic.isMagicCard(cbProvideCardData, cmdBaseWorker.cbMagicCardData) )
//     {
//         if(!gameLogic.isMagicCard(cbProvideCardData-2, cmdBaseWorker.cbMagicCardData)
//         && !gameLogic.isMagicCard(cbProvideCardData-1, cmdBaseWorker.cbMagicCardData)
//         && gameLogic.isHas(handCardDatas, [], [cbProvideCardData-2, cbProvideCardData-1])[0] )
//         {
//             var weaveItem = clone(tagWeaveItem)
//             weaveItem.cbValidCardDatas = [cbProvideCardData-2, cbProvideCardData-1, cbProvideCardData]
//             weaveItem.cbWeaveKind = WIK_RIGHT
...
//         if(!gameLogic.isMagicCard(cbProvideCardData-1, cmdBaseWorker.cbMagicCardData)
//         && !gameLogic.isMagicCard(cbProvideCardData+1, cmdBaseWorker.cbMagicCardData)
//         && gameLogic.isHas(handCardDatas, [], [cbProvideCardData-1, cbProvideCardData+1])[0] )
//         {
//             var weaveItem = clone(tagWeaveItem)
//             weaveItem.cbValidCardDatas = [cbProvideCardData-1, cbProvideCardData, cbProvideCardData+1]
//             weaveItem.cbWeaveKind = WIK_CENTER
...
//         if(!gameLogic.isMagicCard(cbProvideCardData+1, cmdBaseWorker.cbMagicCardData)
//         && !gameLogic.isMagicCard(cbProvideCardData+2, cmdBaseWorker.cbMagicCardData)
//         && gameLogic.isHas(handCardDatas, [], [cbProvideCardData+1, cbProvideCardData+2])[0] )
//         {
//             var weaveItem = clone(tagWeaveItem)
//             weaveItem.cbValidCardDatas = [cbProvideCardData, cbProvideCardData+1, cbProvideCardData+2]
//             weaveItem.cbWeaveKind = WIK_LEFT
...
gameLogic.analyseCard_Peng = function(handCardDatas, cbProvideCardData)
{
    var weaveItems = []
    if(!gameLogic.isMagicCard(cbProvideCardData, cmdBaseWorker.cbMagicCardData)
    && gameLogic.isHas(handCardDatas, [], [cbProvideCardData, cbProvideCardData])[0] )
    {
        var weaveItem = clone(tagWeaveItem)
...
gameLogic.analyseCard_MinGang = function(handCardDatas, cbProvideCardData)
{
    var weaveItems = []
    if( !gameLogic.isMagicCard(cbProvideCardData, cmdBaseWorker.cbMagicCardData)
    && gameLogic.isHas(handCardDatas, [], [cbProvideCardData, cbProvideCardData, cbProvideCardData])[0] )
    {
        var weaveItem = clone(tagWeaveItem)
