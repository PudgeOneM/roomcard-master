...
var CHR_ZHONG_FA_BAI 	= 0x00008000        //中发白
var CHR_ZHENG_FENG 		= 0x00010000        //正风
var CHR_QUAN_FENG 		= 0x00020000        //圈风
var CHR_ZHENG_HUA 		= 0x00040000        //正花
var CHR_ZI_MO 			= 0x00080000        //自摸
var CHR_WU_DA 			= 0x00100000	    //无搭
var CHR_ZIYISE_LUANFENG = 0x00200000	    //乱风
var CHR_QI_BAI_DA 		= 0x00400000	    //七百搭
var CHR_QING_DUIDUI 	= 0x00800000	    //清对对
var CHR_HUN_DUIDUI 		= 0x01000000	    //混对对
var CHR_YE_HUA          = 0x02000000        //野花
var gameLogic = 
{
	...
	IsMagicCard:function( cbCardData, bIsIndex/* = false */)
	{
		var cbCardIndex = MAX_INDEX;
		if (bIsIndex)
			cbCardIndex = cbCardData;
		else
		...
		else
		{
			...
			{
				if (cbCardIndex == mainScene._cbMagicIndex[i])
				{
					return true;
				}
			}
