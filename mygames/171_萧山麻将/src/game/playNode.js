...
{   
    ...
    onCMD_StatusPlay:function() 
    {
        ...
        {  
            publiccount = 0
            var ServerChairID = tableData.getServerChairIdWithShowChairId(j)
            for (var i=0;i<cmdBaseWorker.cbWeaveCount[ServerChairID];i++)
            {
                ...
                if (Item.cbWeaveKind ==WIK_GANG)
                {
                    ...
                    playNode.changeWeaveShowValue(Item.cbCenterCardData,playNode.weaveMajiangs4D[j][i],j,ispublicopen)
                }
            }
        }
    },
    ...
    onCMD_OperateResult:function() 
    {
        ...
        var takeDir =  tableData.getShowChairIdWithServerChairId(cmdBaseWorker.wOperateUser)   
        ...
        if (!isSelf)
        {
            for (var i=0;i<cmdBaseWorker.cbWeaveCount[cmdBaseWorker.wOperateUser];i++)
            {
                ...
                if (c.cbWeaveKind ==WIK_GANG)
                {
                    ...
                    // console.log(111111111111111,c)
                    // var d = playNode.weaveMajiangs4D[takeDir][i][3]
                    // c.cbPublicCard = true
                    // //var b = a[i][3].getChildByTag
                    // console.log(33333333333333,b,d)
                    // d.setSpriteFrame("mf_" + 33+ '.png')
                    // playNode.weaveMajiangs4D[takeDir][i][3].cardData = 33
                    //var aaa = cmdBaseWorker.cbWeaveCount[cmdBaseWorker.wCurrentUser][i].cbCenterCardData
    ...
    setCurrentDiscardMj:function(cardData, direction)
    {
        ...
        else
        {
            ...
            playNode.setCurrentDiscardMj1(cardData, direction,true)
        }
    },
    ...
    playAnimationOfGameEnd:function(call)
    {
        ...
        {
            playNode.playAnimationWithDirection('hu', tableData.getShowChairIdWithServerChairId(cmdBaseWorker.wProvideUser), call)
