...
{   
    ...
    {	
        ...
        for(var wChairID=0;wChairID<SERVER_CHAIR;wChairID++)
        {
            ...
            for(var j=0;j<cmdBaseWorker.cbHandCardCount[wChairID];j++)
            {
                cmdBaseWorker.cbHandCardData[wChairID][j] = isSelf?body.cbHandCardData[j]:0
            }
        }
        ...
        for(var wChairID=0;wChairID<SERVER_CHAIR;wChairID++)
        {
            for(var j=0;j<cmdBaseWorker.cbWeaveCount[wChairID];j++)
            {
                var weaveItem = cmdBaseWorker.WeaveItemArray[wChairID][j]
        ...
        for(var wChairID=0;wChairID<SERVER_CHAIR;wChairID++)
        {   
            cmdBaseWorker.cbPlayerFlowerCardData[wChairID]  = body.cbPlayerFlowerCardData[wChairID].slice(0, body.cbPlayerFlowerCount[wChairID])  
        }
...
// 11111111111111111 维护cbHandCardData todo
    ...
    onCMD_GameEnd:function(body) 
    {
        ...
        for(var wChairID=0;wChairID<SERVER_CHAIR;wChairID++)
        {
            cmdBaseWorker.cbHandCardData[wChairID] = body.cbHandCardData[wChairID].slice(0, cmdBaseWorker.cbHandCardCount[wChairID])
        }
