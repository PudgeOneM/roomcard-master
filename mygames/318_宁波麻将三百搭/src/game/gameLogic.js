...
var CHR_SU_FAN 			= 0x00200000        //素番
var CHR_ZI_MO 			= 0x00400000        //自摸
var CHR_SONG_GANG 		= 0x00800000        //送杠
var CHR_HUAN_GANG 		= 0x01000000	    //还杠
var CHR_WU_DA 			= 0x02000000	    //无搭
var CHR_HUAN_DA 		= 0x04000000	    //还搭
var CHR_SAN_DA 			= 0x08000000	    //三搭
var gameLogic = 
{
	...
	IsMagicCard:function( cbCardData, bIsIndex/* = false */)
	{
		...
		if (mainScene._cbMagicIndexA[0] < 34)
		{
			if (cbCardIndex == mainScene._cbMagicIndexA[0])
			{
				return true;
			}
		}
		else
		{
			...
			{
				if (cbCardIndex == mainScene._cbMagicIndexA[i])
				{
					return true;
				}
			}
