...
{   
    ...
    onCMD_GameEnd:function() 
    {
        ...
        if(cmdBaseWorker.endType == 3)
        {
            ...
            if(provideDiscardMajiangs.length>0 && provideDiscardMajiangs[provideDiscardMajiangs.length-1].cardData == cmdBaseWorker.cbProvideCard) //抢杠情况不会到丢弃区
    ...
    //         cbHandCardData[chairid] = cmdBaseWorker.cbHandCardData[chairid].slice(0, cmdBaseWorker.cbHandCardCount[chairid])
    //     }
    //     //显示手牌
    ...
    //             for(var j = 0;j<4;j++)
    //             {
    //                 if(cmdBaseWorker.cbWeaveCount == 0)
    //                     continue
    ...
    //         {
    //             var cardIdx = cbHandCardData[chairid][i]
    //             if (cardIdx>0 ) 
    //             {
    ...
    {   
       ...
       // var numSmaller = getRandNum(5, numBigger-1) 
        ...
        function getEndNums(direction)
        {
            ...
            {
                var numSmaller = getRandNum(2, numBigger-1) 
