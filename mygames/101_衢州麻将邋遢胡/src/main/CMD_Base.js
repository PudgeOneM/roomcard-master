...
//游戏属性
var KIND_ID = 101								//游戏 I D
var GAME_NAME = "衢州麻将邋遢胡"					//游戏名字
...
//胡牌定义
var CHR_LanBaiDa = 0x0001  //烂百搭 147、148、149、158、159、169、258、259、269、369任意三花色组成加上单风的牌型
...
var CHR_HunPeng = 0x0010	//混碰  由同一种花色及风字组成的碰胡  
var CHR_QingPeng = 0x0020	//清碰  由同一种花色组成的碰胡

var CHR_QiXiaoDui = 0x0040	//七小对 任意花色的七个对子组成 
var CHR_HunQiDui = 0x0080	//混七对 同一种花色及风牌的七个对子组成 
var CHR_QingQiDui = 0x0100	//清七对 同一种花色的七个对子组成    

var CHR_ShiSanBaiDa = 0x0200	//十三百搭    147,258,369加5张不同的风可以由不同于前5张风代替147,258,369任意一张或两张牌   
var CHR_ZhengBaiDa = 0x0400	//真百搭 含有7张风字的十三百搭（147,258,369三花色组成）  

var CHR_QuanFengZi = 0x0800	//全风字 14张全部由风组成的牌型（可以是乱牌） 
var CHR_QuanFengZiDaPengHu = 0x1000	//全风字大碰胡  全都是风字组成的碰碰胡 
var CHR_QuanFengZiQiDui = 0x2000	//全风字七对   全部由风字组成的七对子 

var CHR_QiFengDao = 0x4000	//七风倒 牌里包含7张不同风字（不可吃冲、可自摸） 
var CHR_SanCaiDao = 0x8000	//三财倒 牌里包含3张财神（不可吃冲、可自摸）   

var CHR_GangKai = 0x10000	//杠上开花（杠开）    开杠抓进的牌成和牌   
var CHR_QiangGang = 0x20000	//抢杠  和别人自抓开明杠的牌  

var CHR_TianHu = 0x40000	//天胡
var CHR_DiHu = 0x80000	//地胡 庄家出第一张点炮下家和是地和，牌型不限。  


var CHR_DanDiao = 0x100000	// 单吊 不管什么牌型，最后成单调的都算特殊牌型。
var CHR_HaiDiLaoYue = 0x200000	// 海底捞月 算特殊牌型，即最后一个玩家抓最后一张牌时胡牌，那么就称之为海底捞月。

var CHR_DaDiao = 0x400000	//天吊
var CHR_QiFengLanBaiDa = 0x800000	//七风烂百搭 可自摸可放冲
var CHR_PingHu = 0x1000000  //平胡
