    ...
    {  
        ...
        var l = cc.EventListener.create({
            ...
            {   
                ...
                {
                    if(user.cbGender)
                        managerAudio.playEffect('gameRes/sound/' + (isOpenPTH?'pth':'fy') + '/man/face' + faceId + '.mp3')
                    else
                        managerAudio.playEffect('gameRes/sound/' + (isOpenPTH?'pth':'fy') + '/woman/face' + faceId + '.mp3')
                }
            }
        })
