    ...
    getSelectCardInfo:function( cbOperateCode,SelectInfo )
    {
		...
		if( cbOperateCode&WIK_LEFT||cbOperateCode&WIK_CENTER||cbOperateCode&WIK_RIGHT)
		{
			...
			if( mainScene._cbActionMask & WIK_CENTER )
			{
				...
				SelectInfo[cbSelectCount].cbCardCount = 2;
				SelectInfo[cbSelectCount].cbCardData[0] = tempCard-1;
				SelectInfo[cbSelectCount++].cbCardData[1] = tempCard+1;
			}
			if( mainScene._cbActionMask & WIK_RIGHT )
			{
				...
				SelectInfo[cbSelectCount].cbCardCount = 2;
				SelectInfo[cbSelectCount].cbCardData[0] = tempCard-2;
				SelectInfo[cbSelectCount++].cbCardData[1] = tempCard-1;
			}
		}
		//碰牌
