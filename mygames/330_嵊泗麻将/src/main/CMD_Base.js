...
//游戏属性
var KIND_ID = 330								//游戏 I D
var GAME_NAME = "嵊泗麻将"					//游戏名字
...
var CHR_DaSanYuan = 0x00000010	//大三元  由同一种花色及风字组成的碰胡  
var CHR_QingPeng = 0x00000020	//清一色大三元  由同一种花色组成的碰胡
...
var CHR_XiaoSanYuan = 0x00000200	//清一色一条龙 14张全部由风组成的牌型（可以是乱牌） 
var CHR_QuanFengZiDaPengHu = 0x00000400	//混一色一条龙  全都是风字组成的碰碰胡 
var CHR_QiFengDao = 0x00000800	//混一色大三元 牌里包含7张不同风字（不可吃冲、可自摸） 
var CHR_YiTiaoLong = 0x00001000	//一条龙 牌里包含3张财神（不可吃冲、可自摸）  
var CHR_GangKai = 0x00002000	//杠上开花（杠开）    开杠抓进的牌成和牌   
var CHR_QiangGang = 0x00004000	//抢杠  和别人自抓开明杠的牌  
var CHR_TianHu = 0x00008000	//小三元
var CHR_DiHu = 0x00010000	//清一色小三元 庄家出第一张点炮下家和是地和，牌型不限。  
var CHR_DanDiao = 0x00020000	// 混一色小三元 不管什么牌型，最后成单调的都算特殊牌型。
var CHR_HaiDiLaoYue = 0x00040000	// 大四喜 算特殊牌型，即最后一个玩家抓最后一张牌时胡牌，那么就称之为海底捞月。
var CHR_DaDiao = 0x00080000	//野四花
var CHR_ShiSanBaiDa = 0x00100000	//十三百搭    147,258,369加5张不同的风可以由不同于前5张风代替147,258,369任意一张或两张牌   
var CHR_ZhengBaiDa = 0x00200000	//七星十三烂 含有7张风字的十三百搭（147,258,369三花色组成）  
var CHR_LanBaiDa = 0x00400000  //十三烂 147、148、149、158、159、169、258、259、269、369任意三花色组成加上单风的牌型
var CHR_QiFengLanBaiDa = 0x00800000	//小四喜 可自摸可放冲
var CHR_HasCaiShen = 0x01000000	//天胡
var CHR_ShiSanYao = 0x02000000	//正四花：东南西北中发白，一九万，一九饼，一九条，加其中任意一张组成对，混不能做为财神使用，只能按牌面显示使用，例混为三万时，只能做为三万使用。
var CHR_DianPao = 0x04000000	//大吊
var CHR_DaDiaoGangKai = 0x08000000  //杠开大吊
//#ifdef xxxxxx
var map_mask2Name = 
[
	['CHR_PingHu', '平胡'],
	...
	['CHR_QingQiDui', '清一色七对'],
	['CHR_XiaoSanYuan', '小三元'],
	['CHR_QuanFengZiDaPengHu', '铁壳子'],
	['CHR_QiFengDao', '混一色大三元'],
	['CHR_YiTiaoLong', '一条龙'],
	['CHR_GangKai', '杠开'],
	['CHR_QiangGang', '抢杠'],
	['CHR_TianHu', '天胡'],
	...
	['CHR_ZhengBaiDa', '七星十三烂'],
	['CHR_LanBaiDa', '十三烂'],
	['CHR_QiFengLanBaiDa', '小四喜'],
	['CHR_ShiSanYao', '正四花'],
	['CHR_DianPao', '大吊'],
	['CHR_DaDiaoGangKai', '八花'],
	['CHR_HasCaiShen', '对花'],
]
//#endif
...
[
	...
	['BYTE', 'handcount', 4],
	['BYTE', 'handcarddate', GAME_PLAYER, MAX_COUNT],
	['bool', 'isbahua'],
]
