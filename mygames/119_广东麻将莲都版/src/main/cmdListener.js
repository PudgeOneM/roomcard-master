        ...
        case MDM_GF_GAME:  //游戏消息 200
            {
                ...
                { 
                    ...
                    case SUB_S_PAOSHANG_RESULT:
                    {
                        var body = buffer2StructObj(msg.slice(8), 'CMD_S_PAOSHANG_RESULT');
                        mainScene.onSubPsResult(body.isFanGui, body.maFen); 
                        mainScene.isFanGui = body.isFanGui
                    }  
                }
                break
            }
