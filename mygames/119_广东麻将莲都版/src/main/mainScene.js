...
var mainScene = {
    ...
    runThisScene:function(callAfterRun)
    {
     ...
     onSubPsResult:function(isFanGui, maFen)       
    {
        if (isFanGui) {
            //tableNode.youGuiText.setString("翻鬼")
            mainScene.isFanGui = isFanGui
        } 
        //tableNode.maiMaText.setString((maFen + "马"))
        mainScene.managerUserIn = false
        return true;
    },
    ...
    decorateTableNode:function()
    {
        ...
        //     callback: function(event)
        //     {     
        //         // playNode.gameSetNode.setVisible(tableData.createrUserID == selfdwUserID && !tableData.bIsOpened ) 
        //         // if( (mainScene.managerUserIn == false || cmdBaseWorker.bGameSetEnd == true) && tableData.createrUserID == selfdwUserID) {
