...
//游戏属性
var KIND_ID = 119								//游戏 I D
var GAME_NAME = "广东麻将莲都版"					//游戏名字
...
var CHR_QuanZiSHQiDui3 = 0x00000002  // 全字三豪华七对子
var CHR_QingYiSe = 0x00000004	//清一色 由同一种花色牌组成的胡牌 
var CHR_PengPengHu = 0x00000008	//碰碰胡 由任意花色及风字组成的碰胡   
var CHR_QuanZiSHQiDui = 0x00000010 // 全字双豪华七对子
var CHR_QingPeng = 0x00000020	//清碰  由同一种花色组成的碰胡
var CHR_QiXiaoDui = 0x00000040	//七小对 任意花色的七个对子组成 
var CHR_HaoHuaDaDui = 0x00000080 //豪华大对
var CHR_QingQiDui = 0x00000100	//清七对 同一种花色的七个对子组成    
var CHR_QuanFengZi = 0x00000200	//全风字 14张全部由风组成的牌型（可以是乱牌） 
var CHR_QHWQiDuiZi2 = 0x00000800    // 清一色双豪华七对子
var CHR_QHWQiDuiZi3 = 0x00001000    // 清一色三豪华七对子
var CHR_GangKai = 0x00002000	//杠上开花（杠开）    开杠抓进的牌成和牌   
var CHR_QiangGang = 0x00004000	//抢杠  和别人自抓开明杠的牌  
var CHR_QuanZiDaDui = 0x00008000  // 全字大对

var CHR_QuanZiQiDui = 0x00010000 // 全字七对
var CHR_QuanZiHWQiDui = 0x00020000  //全字豪华七对子

var CHR_HaiDiLaoYue = 0x00040000	// 海底捞月 算特殊牌型，即最后一个玩家抓最后一张牌时胡牌，那么就称之为海底捞月。
var CHR_DaDiao = 0x00080000	//大吊

var CHR_HWQiDuiZi1  = 0x00100000	//豪华七对子
var CHR_HWQiDuiZi2  = 0x00200000	//双豪华七对子
var CHR_HWQiDuiZi3  = 0x00400000	//三豪华七对子
var CHR_QHWQiDuiZi1 = 0x00800000   //清一色豪华七对子
var CHR_HasCaiShen  = 0x01000000	//胡型里是否有财神
var CHR_QDanLiZi	= 0x02000000    //清一色单粒子
var CHR_QFZDanLiZi	= 0x04000000    //全风字单粒子
var CHR_ShiSanYao	= 0x08000000    //十三幺
...
var SUB_S_PAOSHANG_RESULT = 109                                 //翻鬼结果，顺带马分
//空闲状态
...
[
	...
	['BYTE', 'cbMagicCardData'],							//财神牌值						
	['bool', 'bIsRandBanker'],
	['BYTE', 'cbMafenData', MAX_MAFEN],			         	//奖马牌值	
	['BYTE', 'cbDiceNumber'],								//骰子数
	['bool', 'isFanGui'],	
	['BYTE', 'maFen'],
...
[
	...
	['BYTE', 'cbGangData', GAME_PLAYER, MAX_INDEX], //禁杠  				
]
...
var SUB_C_PAOSHANG_RESULT = 7                                   //有鬼结果,顺带马分
//出牌命令
var CMD_C_OutCard = 
[
