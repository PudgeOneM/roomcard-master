...
{   
    ...
    { 
        var psResult = getObjWithStructName('CMD_C_PAOSHANG_RESULT')
        psResult.maFen = 0
        ...
        topUINode.addScore = function()
        {
            if(psResult.maFen < 8)
            {
                psResult.maFen += 2
            }
            topUINode.maCount.setString(psResult.maFen)

        }
        topUINode.subScore = function()
        {
            if(psResult.maFen > 0)
            {
                psResult.maFen -= 2
