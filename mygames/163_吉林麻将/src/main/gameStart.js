...
{   
    managerRes.startPreloadScene(g_resources, function () {
        ...
        cc.spriteFrameCache.addSpriteFrames(resp.gameEndNewPlist, resp.gameEndNewRes)
        cc.spriteFrameCache.addSpriteFrames(resp.typeSelPlist, resp.typeSelPng)
        ...
        cc.spriteFrameCache.addSpriteFrames(resp.dianPlist, resp.dianRes)
        ...
        t = new cc.SpriteFrame(resp.baoPic, cc.rect(0, 0, 38, 37))
        cc.spriteFrameCache.addSpriteFrame(t, "baoPic.png")

        t = new cc.SpriteFrame(resp.bg_logo, cc.rect(0, 0, 139, 176))
        cc.spriteFrameCache.addSpriteFrame(t, "bg_logo.jpg")

        t = new cc.SpriteFrame(resp.ting, cc.rect(0, 0, 74, 38))
        cc.spriteFrameCache.addSpriteFrame(t, "ting.png")

        t = new cc.SpriteFrame(resp.qiting, cc.rect(0, 0, 74, 38))
        cc.spriteFrameCache.addSpriteFrame(t, "qiting.png")
