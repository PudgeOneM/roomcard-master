...
var cardType = 
{
    ...
    {
        console.log(c_sortedCardDatasExcludeLazi,c_sortedCardDatasOfLaizi)
...
[ 
    ...
    [
        {id:4, type:0, name:'zhadan'},
        //{id:4, type:0, name:'zhadan'},
    ],
    [
        {id:4, type:0, length:5, name:'zhadan'},
        //{id:4, type:0, length:5, name:'zhadan'},
    ],
    [
        {id:4, type:0, length:6, name:'zhadan'},
        //{id:4, type:0, length:6, name:'zhadan'},
    ],
    [
        {id:4, type:0, length:7, name:'zhadan'},
        //{id:4, type:0, length:7, name:'zhadan'},
    ],
    [
        {id:4, type:0, length:8, name:'zhadan'},
        //{id:4, type:0, length:8, name:'zhadan'},
    ],
    [
        {id:4, type:0, length:9, name:'zhadan'},
        //{id:4, type:0, length:9, name:'zhadan'},
    ],
    [
        {id:4, type:0, length:10, name:'zhadan'},
        //{id:4, type:0, length:10, name:'zhadan'},
    ],
    [
        {id:4, type:0, length:11, name:'zhadan'},
        //{id:4, type:0, length:11, name:'zhadan'},
    ],
    [
        {id:4, type:0, length:12, name:'zhadan'},
        //{id:4, type:0, length:12, name:'zhadan'},
    ],
    [
