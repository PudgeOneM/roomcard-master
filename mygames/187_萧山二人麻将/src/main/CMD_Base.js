...
//游戏属性
var KIND_ID = 187								//游戏 I D
var GAME_NAME = "萧山二人麻将"			//游戏名字
...
var MAX_FLOWER_COUNT = 1	//无花时设置为0 m_cbFlowerIndex[MAX_FLOWER_COUNT]不赋值即可   
var MAX_RIGHT_COUNT = 1	//最大权位DWORD个数 允许几个人同时胡(一炮多响)
var MAX_WEAVE = 4	//最大组合
var HEAP_FULL_COUNT = 34	//堆立全牌 

//假财神
var REPLACE_CARD_DATA = 0x37//无假财神时设置为INVALID_CARD_DATA
...
var START_MODE = START_MODE_ALL_READY //麻将模式的选择//添加代码
///////////////游戏配置 end////////////
...
var CHR_BaoTou = 0x00000002	//爆头  由同一种花色及风牌组成的胡牌 
var CHR_HaoHuaQiDui = 0x00000004	//豪华七对 由同一种花色牌组成的胡牌 
var CHR_ErHaoHuaQiDui = 0x00000008	//二豪华七对 由任意花色及风字组成的碰胡   
var CHR_SanHaoHuaQiDui = 0x00000010	//三豪华七对  由同一种花色及风字组成的碰胡  
var CHR_CaiPiao = 0x00000020	//飘财  由同一种花色组成的碰胡
var CHR_QiXiaoDui = 0x00000040	//七小对 任意花色的七个对子组成 
var CHR_ShiFengZi = 0x00000080	//十风字 同一种花色及风牌的七个对子组成 
...
var CHR_GangBao = 0x00004000	//杠爆  和别人自抓开明杠的牌  
var CHR_GangPiao = 0x00008000	//杠飘
var CHR_PiaoGang = 0x00010000	//飘杠 庄家出第一张点炮下家和是地和，牌型不限。  
var CHR_PengPengHu = 0x00020000	//碰碰胡 不管什么牌型，最后成单调的都算特殊牌型。
var CHR_QingYiSe = 0x00040000	//清一色 算特殊牌型，即最后一个玩家抓最后一张牌时胡牌，那么就称之为海底捞月。
var CHR_DaDiao = 0x00080000	//大吊
var CHR_TianHu = 0x00100000	//天胡    147,258,369加5张不同的风可以由不同于前5张风代替147,258,369任意一张或两张牌   
var CHR_DiHu = 0x00200000	//地胡 含有7张风字的十三百搭（147,258,369三花色组成）  
...
var CHR_Zimo = 0x02000000	//自摸：东南西北中发白，一九万，一九饼，一九条，加其中任意一张组成对，混不能做为财神使用，只能按牌面显示使用，例混为三万时，只能做为三万使用。
...
var CMD_S_SendCard = 
[
	['bool', 'Ispublic', MAX_WEAVE],	//放着杠的状态，因为如果是暗杠，一圈后需要将上面的牌翻开
...
var CMD_S_GameEnd = 
[
	['BYTE', 'cbFengNum', GAME_PLAYER],				//杭州麻将	风的数量
	['BYTE', 'cbAnGang', GAME_PLAYER],				//杭州麻将	杠的次数只有在特定胡型下才会被传过去，否则传的是0
	['BYTE', 'cbMingGang', GAME_PLAYER],				//杭州麻将	杠的次数只有在特定胡型下才会被传过去，否则传的是0
	['BYTE', 'cbSRECount', GAME_PLAYER],	//萧山麻将	连续杠的次数
	['BYTE', 'cbMagicCount', GAME_PLAYER],			//杭州麻将	打出财神的数量
	['BYTE', 'cbWinUserBaseScore'],					//基础分数，可以用来分辨连庄
...
[
	//杭州麻将	数据变量
	['bool', 'Ispublic', GAME_PLAYER, MAX_WEAVE],	//放着杠的状态，因为如果是暗杠，一圈后需要将上面的牌翻开
	//游戏变量
