...
//游戏属性
var KIND_ID = 108								//游戏 I D
var GAME_NAME = "慈溪麻将"					//游戏名字
...
var INVALID_CARD_DATA = 0
//用于财神的转换，如果有牌可以代替财神本身牌使用，则设为该牌索引，否则设为0. 注:如果替换牌是序数牌,将出错.
var REPLACE_CARD_DATA = INVALID_CARD_DATA//0x99	
...
var CHR_KaoBing = 0x00000010	//靠壁靠柄  
var CHR_WuLong = 0x00000020	//无龙 
var CHR_QiXiaoDui = 0x00000040	//七小对 任意花色的七个对子组成 
var CHR_YiLong = 0x00000080	//一龙  
var CHR_ShuangLong = 0x00000100	//双龙     
var CHR_QuanFengZi = 0x00000200	//全风字 14张全部由风组成的牌型（可以是乱牌） 
var CHR_SanLong = 0x00000400	//三龙  
var CHR_QiFengDao = 0x00000800	//七风倒 牌里包含7张不同风字（不可吃冲、可自摸） 
var CHR_SiLong = 0x00001000	//四龙  
var CHR_GangKai = 0x00002000	//杠上开花（杠开）    开杠抓进的牌成和牌   
var CHR_QiangGang = 0x00004000	//抢杠胡
var CHR_PaoHua = 0x00008000	//抛花
var CHR_FeiMa = 0x00010000	//飞马。  
var CHR_DanDiao = 0x00020000	// 单吊 不管什么牌型，最后成单调的都算特殊牌型。
var CHR_TianHu = 0x00040000	// 天胡
var CHR_DaDiao = 0x00080000	//大吊
var CHR_ShiSanBaiDa = 0x00100000	//十三百搭    147,258,369加5张不同的风可以由不同于前5张风代替147,258,369任意一张或两张牌   
var CHR_GangTouPaoHua = 0x00200000	//杠头抛花  
var CHR_DiHu = 0x00400000  //地胡
var CHR_ShiLianFeng = 0x00800000	//十连风
var CHR_QianDang = 0x01000000	//坎档（  嵌档）
var CHR_RePao = 0x02000000	//热炮
var CHR_ZiMo = 0x04000000	//自摸
//#ifdef xxxxxx
var map_mask2Name = 
[
	['CHR_PingHu', '平胡'],
...
[
	...
	['BYTE', 'cbRmCardData'],							//移除牌值
	// ['DWORD', 'dwCurrentRoundPlayerUserId', GAME_PLAYER],//当前轮游戏玩家
	['BYTE', 'cbCurrentRoundGameSet', GAME_PLAYER, 2],//下跑 加顶分
]
