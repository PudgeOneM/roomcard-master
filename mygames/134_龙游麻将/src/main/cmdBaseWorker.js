...
{   
    ...
    //其他
    cbCallRecord:null,
    cbSiceCount:null,//抓牌筛子
    cbSiceCountMG:null,//财神筛子
    cdwgenpaiCount:null,//跟牌次数
    dxgenpaiCount:null,//断线重连时保存跟牌次数
    TurnoverCard:null,
    cbPrebank:null,//是不是老庄
    dwLastWinner:[],
    init:function()
    {   
    },
    ...
    {	
        cmdBaseWorker.dxgenpaiCount   = body.dxgenpaiCount
    ...
    onCMD_GameStart:function(body) 
    {
        ...
        cmdBaseWorker.cbSiceCount     = body.cbSiceCount   //抓牌筛子
    ...
    onCMD_OutCard:function(body)
    {
        ...
        cmdBaseWorker.cdwgenpaiCount = body.cdwgenpaiCount//跟牌次数
        // console.log("跟牌次数",body.cdwgenpaiCount)
        cmdBaseWorker.wOutCardUser = body.wOutCardUser
        cmdBaseWorker.cbOutCardData = body.cbOutCardData
    ...
    {        
        ...
        cmdBaseWorker.cbGangmagic    = body.cbGangmagic  
        cmdBaseWorker.wCurrentUser   = body.wCurrentUser
        cmdBaseWorker.wTakeCardUser  = body.wTakeCardUser
        cmdBaseWorker.cbPrebank      = body.cbPrebank
        //console.log(body.wTakeCardUser)
        cmdBaseWorker.cbSendCardCount = body.cbSendCardCount
        cmdBaseWorker.sendCardArray   = body.sendCardArray
        cmdBaseWorker.sendCardArray2  = body.sendCardArray2
    ...
    onCMD_OperateResult:function(body) 
    {
        ...
        cmdBaseWorker.cbSiceCountMG     = body.cbSiceCountMG   //杠后的筛子
