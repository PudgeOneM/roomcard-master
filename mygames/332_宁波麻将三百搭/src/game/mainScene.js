...
var mainScene = {
  ...
  sortHandCard:function(cbCardData)
  {
      var sortBP = function(cbCardData)
      {
        ...
        {
            if (cbIndex == mainScene._cbMagicIndexA[0])
            {
        ...
        else
        {
            for (var i = 0; i < MAX_MAGIC_INDEX_ARRAY; i++) {
                if (cbIndex == mainScene._cbMagicIndexA[i])
                {
                  return cbCardData-200;
                }
            };
  ...
  onEventScenePlay:function(data)
  {
      ...
      mainScene._cbBao           = [];
      mainScene._cbMagicIndexA   = [];
      mainScene._cbMagicIndexA   = data.cbMagicIndex;
      mainScene._cbMagicIndex    = data.cbMagicIndexEx;
