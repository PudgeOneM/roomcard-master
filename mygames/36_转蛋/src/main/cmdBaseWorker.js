...
{   
    ...
    cbPlayCount:0,
    bPass:[],
    wOutOrder:[0, 1, 2, 3],                           //出牌顺序
    cbFriendCard:null,                      //对家翻拍
    ...
    cbOutCardData:[],     //出牌数据
    outCardType:{cbType:CT_ERROR, cbLength:0, cbLogicValue:0, wTakeType:TAKE_NONE},
    ...
    onReStart:function()
    {
        ...
        cmdBaseWorker.outCardType = {cbType:CT_ERROR, cbLength:0, cbLogicValue:0, wTakeType:TAKE_NONE}
        cmdBaseWorker.cbFriendCard = 0
    },
    onCMD_StatusFree:function(body) 
    {
        cmdBaseWorker.lCellScore = body.lCellScore
        cmdBaseWorker.wOutOrder = body.wOutOrder
    },
    ...
    onCMD_StatusPlay:function(body) 
    {
        ...
        cmdBaseWorker.outCardType = body.outCardType
        cmdBaseWorker.cbHandCardCount = body.cbHandCardCount
        ...
        cmdBaseWorker.cbFriendCard = body.cbFriendCard
        ...
        gameLogic.cbMagicCards = body.cbMagicCard
    },
    ...
    onCMD_PassCard:function(body) 
    {
        ...
        cmdBaseWorker.bPass[cmdBaseWorker.wPassCardUser] = true
        cmdBaseWorker.bPass[cmdBaseWorker.wCurrentUser] = false
    },
