...
{   
    ...
    wWinner:null,
    endType:null,
    cbGangStatus:null,  //杠开状态
    cbHuCount:null,     //胡牌的人数
    cbHorseIndex:null,
    cbLackYesData:null,
    ...
    onReStart:function()
    {
        ...
        cmdBaseWorker.cbHorseCardData   = null
        ...
        cmdBaseWorker.cbGangStatus      = null
        cmdBaseWorker.cbHuCount         = null
        cmdBaseWorker.cbHorseIndex      = null
        cmdBaseWorker.cbLackYesData     = null
        cmdBaseWorker.cbIsPreStartEnd   = null
        cmdBaseWorker.cbPlayType        = null
        cmdBaseWorker.cbCallRecord = null
    },
    ...
    {	
        ...
        cmdBaseWorker.cbLackYesData   = body.cbLackYesData
    ...
    onCMD_GameEnd:function(body) 
    {
        ...
        cmdBaseWorker.cbHorseCardData = body.cbHorseCardData
        cmdBaseWorker.cbGangStatus    = body.cbGangStatus
        cmdBaseWorker.wOutCardUser    = body.wOutCardUser
        cmdBaseWorker.cbHuCount       = body.cbHuCount
        cmdBaseWorker.cbHorseIndex    = body.cbHorseIndex
    ...
    // }
    onCMD_LackNoResult:function(body)
    {
        cmdBaseWorker.cbPlayType = body.cbLackNo
    },
    onCMD_LackYesResult:function(body)
    {
        cmdBaseWorker.cbLackYesData = body.cbLackYesData
        ...
        for(var i = 0; i < 4; i++)
        {
            if (cmdBaseWorker.cbLackYesData[i] == 0)
            {
