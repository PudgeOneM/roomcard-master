...
{   
    ...
    cbLiujuCount:0,
    bthePiaoHuaUser:[],
    wCanPiaoHuaUser:INVALID_WORD,
    isCHongLian:false,
    bSendCardData:0,
    wShowLightUser:INVALID_WORD,
    //////////嘉兴，结束///////////
    lCellScore:null,
    //user变量
    ...
    {
        //////////////// 嘉兴规则，开始 ////////////////
        cmdBaseWorker.clMoreScore         = []
        cmdBaseWorker.bthePiaoHuaUser     = []
        cmdBaseWorker.cbPiaoHuaCount      = 0
        cmdBaseWorker.cbGangCount         = 0
        cmdBaseWorker.bIsZhengDiao        = false
        cmdBaseWorker.cbForbidOutData     = null
        cmdBaseWorker.mHandCardData       = null
        cmdBaseWorker.wCanPiaoHuaUser     = INVALID_WORD
        cmdBaseWorker.wShowLightUser      = INVALID_WORD
        //////////////// 嘉兴规则，结束 ////////////////
    ...
    onCMD_StatusFree:function(body) 
    {
        ...
        ///////////// 以下是嘉兴规则 ///////////////
        cmdBaseWorker.cbSelectResult = body.cbSelectResult
    },
    ...
    {	
        ...
        cmdBaseWorker.bthePiaoHuaUser       = body.bthePiaoHuaUser
        cmdBaseWorker.wCanPiaoHuaUser       = body.wCanPiaoHuaUser
        cmdBaseWorker.bSendCardData         = body.bSendCardData
        cmdBaseWorker.sendCardArray         = body.sendCardArray
        cmdBaseWorker.cbSiceCount           = body.cbSiceCount
        cmdBaseWorker.wShowLightUser        = body.wShowLightUser
        ///////////// 嘉兴规则，结束 ///////////////
    ...
    onCMD_SendCard:function(body) 
    {
       // console.log(66666, clone(body))
        ...
        cmdBaseWorker.cbLeftCardCount = cmdBaseWorker.cbLeftCardCount - cmdBaseWorker.cbSendCardCount
         ...
         ///////////// 以下是嘉兴规则 ///////////////
        cmdBaseWorker.bIsZhengDiao    = body.bIsZhengDiao
        cmdBaseWorker.bthePiaoHuaUser = body.bthePiaoHuaUser
        cmdBaseWorker.wCanPiaoHuaUser = body.wCanPiaoHuaUser        
    },
    ...
    onCMD_GameEnd:function(body) 
    {
        ...
        cmdBaseWorker.cbLiujuCount    = body.cbLiujuCount
        ...
        cmdBaseWorker.cbWeaveCount    = body.cbWeaveCount    
        cmdBaseWorker.WeaveItemArray  = body.WeaveItemArray  
        cmdBaseWorker.clMoreScore     = body.clMoreScore
        cmdBaseWorker.cbPiaoHuaCount  = body.cbPiaoHuaCount
        cmdBaseWorker.cbGangCount     = body.cbGangCount
        // for(var i=0; i<GAME_PLAYER; i++)
        // {
        //     if(cmdBaseWorker.clMoreScore[i] != 10)
        //         cmdBaseWorker.clMoreScore[i] = 0
        // }
