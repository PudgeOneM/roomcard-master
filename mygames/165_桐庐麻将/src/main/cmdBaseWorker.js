...
console.log(cmdBaseWorker.cbActionMask )
    ...
    onCMD_GameEnd:function(body) 
    {
        ...
        cmdBaseWorker.cbkind   = body.wkind
        cmdBaseWorker.Contract = body.wContract
        cmdBaseWorker.nGangcount= body.nGangcount
        console.log(222222222222,cmdBaseWorker.Contract)
        cmdBaseWorker.cbWeaveCount    = body.cbWeaveCount    
        cmdBaseWorker.WeaveItemArray  = body.WeaveItemArray  
    },
