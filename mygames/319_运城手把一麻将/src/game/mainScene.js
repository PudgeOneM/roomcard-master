...
var mainScene = {
  ...
  inittopUICCB:function()
  {
      ...
      topUI["spriteBale"+0]=topUI.spriteBale0;
      topUI["spriteBale"+1]=topUI.spriteBale1;
      topUI["spriteBale"+2]=topUI.spriteBale2;
      topUI["spriteBale"+3]=topUI.spriteBale3;
  ...
  onEventScenePlay:function(data)
  {
      ...
      for(var i=0;i<GAME_PLAYER;i++)
      {
        if(data.bBaYi[i])
        {
          var wOperateViewID = gameLogic.switchViewChairID(i);
          topUI['spriteBale'+wOperateViewID].visible = true;
        }
      }
  ...
  onSubBaYi:function(data)
  {
      //播放动画
      operateAmt.setAmtInfo(data.wChairID,WIK_BALE);
