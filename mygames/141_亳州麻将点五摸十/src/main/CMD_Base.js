...
//游戏属性
var KIND_ID = 141								//游戏 I D
var GAME_NAME = "亳州麻将点五摸十"					//游戏名字
...
[
	...
	['BYTE', 'cbSiceCount', 4],
	['bool', 'bIsRandBanker'],
	['BYTE', 'isListen', GAME_PLAYER], //是否听牌
	['DWORD', 'dwBankerUserId'],								//庄家用户
...
[	
	...
	['BYTE', 'cbTingCardArray', GAME_PLAYER, MAX_TINGCARD],                      //
	['BYTE', 'isListen', GAME_PLAYER], //是否听牌
	['BYTE', 'AnGangCard', GAME_PLAYER, 4],
...
[
	...
	['BYTE', 'isListen', GAME_PLAYER], //是否听牌
	['bool', 'isZimoHu'],
	['BYTE', 'AnGangCard', GAME_PLAYER, 4],					//暗杠翻拍
	//状态变量
	['BYTE', 'cbActionMask'],								//动作掩码
	['WORD', 'wProvideUser'],						//供应用户
