...
//游戏属性
var KIND_ID = 323									//游戏 I D
var GAME_NAME = "温州放炮麻将"					//游戏名字
...
var RULE_NULL			=		0x00					//未确定规则
var RULE_CAN_DIAN_PAO	=		0x01					//是否允许点炮
var RULE_ONLY_ZIMO		=		0x02					//自能自摸
...
var SUB_S_ZHUA_MA_RESULT	= 117							//抓码结果
...
[
	['BYTE', 'cbRule'],								//是否允许点炮结果
]

//抓码结果
var CMD_S_ZhuaMaResult = 
[
	['BYTE', 'cbZhuaMaCount'],						//抓码的数量			
]
//////////////////////////////////////////////////////////////////////////
//客户端命令结构
...
var SUB_C_FANG_ZHU		= 11						//设置首局庄家
var SUB_C_ZHUA_MA		= 12						//请求抓码
