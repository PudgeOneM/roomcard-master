...
{   
    ...
    initCardData2ScoreMap:function()
    {
        ...
        var rightCardData = [0x0A, 0x2A]//  cmdBaseWorker.cbMagicCardData 

        for(var i=0;i<rightCardData.length;i++)
        {
            if(rightCardData[i] == INVALID_CARD_DATA)
                break
            cardDatas[cardDatas.length] = rightCardData[i]
            scores[scores.length] = 1000+rightCardData[i]
        }
