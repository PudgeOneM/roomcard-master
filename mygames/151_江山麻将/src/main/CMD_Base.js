...
//游戏属性
var KIND_ID = 151								//游戏 I D
var GAME_NAME = "江山麻将"					//游戏名字
...
//其他
var MAX_SEND_COUNT = 9//摸到所有花补花 要发一样多的牌 MAX_FLOWER_COUNT											
var MAX_OPERATE_COUNT = 9//客户端执行动作时发给服务器的麻将最大数 如果有补花操作 可能出现摸到所有花补花 MAX_FLOWER_COUNT		
...
var CHR_SiCai = 0x00000002	//混一色  由同一种花色及风牌组成的胡牌 
...
var CHR_GangKai_Peng = 0x00400000  //烂百搭 147、148、149、158、159、169、258、259、269、369任意三花色组成加上单风的牌型
var CHR_GangKai_Ming = 0x00800000	//七风烂百搭 可自摸可放冲
var CHR_GangKai_An = 0x01000000	//胡型里是否有财神
...
[
	...
	['CHR_GangKai_Peng', '风险杠杠开'],
	['CHR_GangKai_Ming', '明杠杠开'],
	['CHR_GangKai_An', '暗杠杠开'],
	['CHR_ShiSanYao', '十三幺'],
]
//#endif
...
var CMD_S_GameStart = 
[
	['WORD', 'wOutCardState', GAME_PLAYER],
	['BYTE', 'cbSiceCount', 4],
	['bool', 'bIsRandBanker'],
	['DWORD', 'dwBankerUserId'],								//庄家用户
