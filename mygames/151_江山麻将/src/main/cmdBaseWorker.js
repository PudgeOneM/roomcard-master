...
{   
    ...
    onReStart:function()
    {
        cmdBaseWorker.wOutCardState = []
        cmdBaseWorker.m_RightCardData = INVALID_CARD_DATA
    ...
    {	
        cmdBaseWorker.wOutCardState   = body.wOutCardState
        ...
        cmdBaseWorker.m_RightCardData = body.m_RightCardData   
    ...
    onCMD_SendCard:function(body) 
    {
        ...
        cmdBaseWorker.wProvideUser    = body.wProvideUser 
        cmdBaseWorker.cbProvideCardData    = body.cbProvideCardData  
       // cmdBaseWorker.cbGangCardData = body.cbGangCardData  
    ...
    searchGangCardDatas:function(handMajiangs, weaveMajiangs,wChairID) //自摸杠时找到杠哪个 服务器传? TODO
    {
        //暗杠
        ...
        for(var i=0;i<handCardDatas.length;i++)
        {
            ...
            if(cardData == cmdBaseWorker.cbMagicCardData[0])
                continue
        ...
        if(cmdBaseWorker.wOutCardState[wChairID] != 0)
            zengGangCardDatas = []
