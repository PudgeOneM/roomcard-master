...
//游戏属性
var KIND_ID = 128								//游戏 I D
var GAME_NAME = "嘉兴硬自摸"					//游戏名字
...
var CMD_S_SELECT = 
[
	['BYTE', 'cbSelectResult', GAME_PLAYER],				//记录玩家选择结果
	['BYTE', 'cbAlreadySelect'],							//玩家是否已经选择
]
...
[
	...
	['BYTE', 'cbCallRecord', GAME_PLAYER, 2],			//下跑 加顶分
	['BYTE', 'cbIsNeedChengBao'],						//构成承包关系
	['BYTE', 'cbAlreadySelect'],
	['BYTE', 'cbSelectResult', GAME_PLAYER],
]
...
[
	...
	['BYTE', 'cbHandCardData', MAX_COUNT],			//add at 0712-pm
]
...
[	
	...
	['BYTE', 'cbIsNeedChengBao'],					 //构成承包关系,add at 0704
	['WORD', 'cwUserChengBao', 6],
]
...
[
	...
	['BYTE', 'cbAlreadySelect'],								//玩家是否已经选择						
	['BYTE', 'cbSelectResult', GAME_PLAYER],					//记录玩家选择结果
	['WORD', 'cwUserChengBao', 6],							//建立承包关系的两个玩家，0-3记录碰的玩家，4-5记录这两个玩家
]
//////////////////////////////////////////////////////////////////////////
//客户端命令结构
...
var CMD_C_SELECT = 
[
	['BYTE', 'isAbandon'],					//选择是否放弃，0未选择，1放弃，2继续
]
