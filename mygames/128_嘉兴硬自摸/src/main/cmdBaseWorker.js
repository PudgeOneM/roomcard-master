...
{   
    ...
    onReStart:function()
    {
        ...
        cmdBaseWorker.cbIsNeedChengBao    = 0
        cmdBaseWorker.cbAlreadySelect     = 0
        cmdBaseWorker.cbSelectResult      = [] 
        cmdBaseWorker.cwUserChengBao      = null
    ...
    {	
        ...
        //嘉兴规则
        cmdBaseWorker.cbIsNeedChengBao      = body.cbIsNeedChengBao
        cmdBaseWorker.cbSelectResult        = body.cbSelectResult
        cmdBaseWorker.cbAlreadySelect       = body.cbAlreadySelect
        cmdBaseWorker.cwUserChengBao        = body.cwUserChengBao
    ...
    onCMD_OperateResult:function(body) 
    {
        ...
        cmdBaseWorker.wProvideUser         = body.wProvideUser   
        cmdBaseWorker.cbProvideCardData    = body.cbProvideCardData    
        //console.log(666, cmdBaseWorker.cbProvideCardData )
        cmdBaseWorker.wCurrentUser         = body.wCurrentUser
