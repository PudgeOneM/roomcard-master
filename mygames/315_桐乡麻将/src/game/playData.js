                    ...
                    {   
                        switch(tableData.CMD_GF_GameStatus.cbGameStatus)
                        {
                            case GAME_SCENE_FREE:
                            {
                                ...
                                {
                                    mainScene.onSubYphResult(body.bYiPianHu);
                                }
                                break;
                            }
        ...
        switch(head.CommandInfo.wMainCmdID)
        {
            case MDM_GF_GAME:       //游戏消息 200
            {
                switch(head.CommandInfo.wSubCmdID)
                {
                    ...
                    case SUB_S_YIPIANHU_RESULT:
                    {
                        var body = buffer2StructObj(msg.slice(8), 'CMD_S_YIPIANHU_RESULT');
                        return mainScene.onSubYphResult(body.bYiPianHu); 
                    }
                }
                break;
            }
