...
{   
    ...
    managerRes.startPreloadScene(g_resources, function () {
        ...
        cc.spriteFrameCache.addSpriteFrames(resp.gameAmtKunShanPlist0, resp.gameAmtKunShan0)
        cc.spriteFrameCache.addSpriteFrames(resp.gameAmtKunShanPlist1, resp.gameAmtKunShan1)
        onLoad?onLoad():''
    }, this)
