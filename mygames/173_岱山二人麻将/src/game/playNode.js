...
/////////////////////////@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    _removeSprsOnGameEnd:function()
    {
        ...
        {   
            var chairid = tableData.getServerChairIdWithShowChairId(chairId)
    ...
    showActionBtns:function(sortedActions)
    {
        ...
        {   
            ...
            btn.setVisible(true)
            btn.setPositionX(-140 * (sortedActions.length-1-i +1))
        ...
        else if(cmdBaseWorker.endType == 3)
        {
            ...
            { // 非自摸
                ...
                for (var i = 0; i < GAME_PLAYER; i++)
                {
                    ...
                    {
                        winner = i
                        playNode.playAnimationWithDirection('hu', playNode.reGetShowChairId(tableData.getShowChairIdWithServerChairId(winner)), (iscall==false)?call:'')
