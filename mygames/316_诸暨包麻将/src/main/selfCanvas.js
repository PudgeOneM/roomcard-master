...
chairFactory2getOne = chairFactory2.getOne
chairFactory2.getOne=function(chairNode)
{   
    var chair = chairFactory2getOne(chairNode)
    chair.node.setScale(0.8)
    return chair
}

chairFactory2_getUserNodeInsetChair = chairFactory2._getUserNodeInsetChair
chairFactory2._getUserNodeInsetChair=function(chairNode)
{   
    var userNodeInsetChair = chairFactory2_getUserNodeInsetChair()
    userNodeInsetChair.faceNode.setScale(1.25)
    return userNodeInsetChair
}
