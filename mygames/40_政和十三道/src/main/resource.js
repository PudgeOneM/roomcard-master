...
[	//这个数组里的资源会进行MD5比对 决定是否下载还是取缓存 
	...
	resp.buttonResPlist,
	resp.buttonRes,
	resp.buttonResMaxPlist,
	resp.buttonResMax,
	resp.chooseSpecialResPlist,
	resp.chooseSpecialRes,
...
var res = {
    //btn_duizi : "res/gameRes/pic/button.png",
    //btn_liangdui : "res/MainScene.json"
};
var base64Array = []
