...
{   
    ...
    popGameEnd:function(continueCall, userData_gameEnd)
    {
        ...
        var m_MaPaiLabel = new cc.LabelTTF("", "Arial", 16)
    ...
    ////////////////////////// 嘉兴规则结束 ////////////////////////////
            ...
            if(wChairID==cmdBaseWorker.wExitUser)
                ...
                //control.maPaiLabel.setPosition(cc.p(gendBar.getContentSize().width*0.50, gendBar.getContentSize().height*4))
                m_MaPaiLabel.setPosition(cc.p(gendBar.getContentSize().width*0.4, gendBar.getContentSize().height*0.221))
                m_MaPaiLabel.setString(nameStr)
                gendBar.addChild(m_MaPaiLabel)
            }
