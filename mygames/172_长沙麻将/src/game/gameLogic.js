...
gameLogic.analyseCard_MinBu = function(handCardDatas, cbProvideCardData)
{
    var weaveItems = []
    if( gameLogic.isHas(handCardDatas, [], [cbProvideCardData, cbProvideCardData, cbProvideCardData])[0] )
    {
...
gameLogic.analyseCard_AnBu = function(handCardDatas)
{
    var weaveItems = []
...
gameLogic.analyseCard_PengBu = function(weaveItemArray, handCardDatas)
{
    var weaveItems = []
...
// gameLogic.searchGangCardDatas = function(handCardDatas, weaveItemArray) //自摸杠时找到杠哪个 服务器传? TODO
// {
//     //暗杠
...
//     var pengGangCardDatas = gameLogic.analyseCard_PengGang(handCardDatas, weaveItemArray)
//     var anGangCardDatas = gameLogic.analyseCard_AnGang(handCardDatas)
...
// gameLogic.bao2Cai = function(cardData)
// {
...
// gameLogic.cai2Bao = function(cardData)
// {
