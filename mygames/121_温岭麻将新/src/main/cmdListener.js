        ...
        case MDM_GF_GAME:  //游戏消息 200
            {
                ...
                {   
                    ...
                    var event = new cc.EventCustom("cmdEvent")
                    event.setUserData(['onCMD_GamePreStart'])
                    cc.eventManager.dispatchEvent(event)
                ...
                {   
                    ...
                    cmdBaseWorker.onCMD_ReplaceCard(body)

                    //var event = new cc.EventCustom("cmdEvent")
                    //event.setUserData(['onCMD_ReplaceCard'])
                    //cc.eventManager.dispatchEvent(event)

                    playNode.onCMD_ReplaceCard(body);
                    break
                }   
                case SUB_S_OUT_CARD: 
                {   
                ...
                case SUB_S_DINGPENG_RESULT: 
                {  
                    var body = buffer2StructObj(msg.slice(8), 'CMD_S_DingPeng_Result') 
                    cmdBaseWorker.onCMD_DingPengResult(body)
