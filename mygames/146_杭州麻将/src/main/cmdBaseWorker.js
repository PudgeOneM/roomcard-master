...
{   
    ...
    //杭州麻将变量
    cbForbidEatAndOutCardData:null,
    cbFengNum:null,
    bIsOutMagic:null,
    bIsForbidActionUser:null,
    cbGangCount:null,
    cbMagicCount:null,
    init:function()
    {   
    ...
    {	
        cmdBaseWorker.cbForbidEatAndOutCardData = body.cbForbidEatAndOutCardData
        cmdBaseWorker.bIsOutMagic          = body.bIsOutMagic
        cmdBaseWorker.bIsForbidActionUser  = body.bIsForbidActionUser
