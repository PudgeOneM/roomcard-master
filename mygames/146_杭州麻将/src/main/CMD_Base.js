...
var CMD_S_GameStart = 
[
	['BYTE', 'cbForbidEatAndOutCardData', 2],//不能吃什么打什么，不能打的牌最多就两张
	['bool', 'bIsOutMagic', GAME_PLAYER],//这边放着玩家的状态是否打过财神
	['WORD', 'bIsForbidActionUser', 2],//只记录两个玩家即可，因为两个玩家打财神，全场没有吃碰与点炮杠
...
[
	...
	['BYTE', 'cbGangCount', GAME_PLAYER],				//杭州麻将	杠的次数只有在特定胡型下才会被传过去，否则传的是0
