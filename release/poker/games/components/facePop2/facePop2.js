...
var facePop2 = 
{
    ...
    {  
        ...
        listView_Voice.x = 0
        listView_Voice.y = -5
        listView_Voice.setItemsMargin(6)
        ...
        for( var i = 0; i < self.voiceArray.length; i++ )
        {
            ...
            btn.addClickEventListener(function(btn) {
                self._sendExpression(btn.index + 1000)
            }.bind(this))
        }
    ...
    _sendExpression:function(faceId)
    {
        ...
        else
        {
            ...
            UserExpression.wItemIndex = faceId
    ...
    showCommonVoice:function(user, voiceIndex)
    {
        ...
        {
            if(user && user.userNodeInsetChair)
                user.userNodeInsetChair.faceNode.removeAllChildren()
        }
        ...
        var voiceTextNode = cc.LabelTTF.create('', "Helvetica", 26)
