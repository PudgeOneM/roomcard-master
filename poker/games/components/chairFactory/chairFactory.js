...
{   
    ...
    preLoadRes:
    [
    'components/chairFactory/res/chairFactory.plist', 
    'components/chairFactory/res/chairFactory.png'
    ],
    ...
    _initUserNode:function()
    {
        ...
        userNode.userScore = cc.LabelTTF.create('', "Helvetica", 16)
        userNode.userScore.setFontFillColor( cc.color(242, 255, 233, 255) )
        userNode.userScore.setPosition(cc.p(0, -37))
    ...
    {   
        ...
        {   
            ...
            userNodeInsetChair.bankerNode.setPosition( cc.p(18, 19) )              
        }
        else
        {   
            userNode.headNode.setVisible(false)
