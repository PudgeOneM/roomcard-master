...
{   
    ...
    preLoadRes:
    [
    'components/userSettingPop/res/userSettingPop.plist', 
    'components/userSettingPop/res/userSettingPop.png'
    ],
    strSwitchTTF_2:'是否使用普通话',
    ...
    {   
        ...
        if(gameorientation == 'landscape')
            node.setScale(0.8)
        control['switchTTF_2'].setString(userSettingPop.strSwitchTTF_2);
        return node
    },
