...
var menuSide = 
{
    ...
    preLoadRes:
    [
    'components/menuSide/res/menuSide.plist', 
    'components/menuSide/res/menuSide.png'
    ],
    ...
    {   
        ...
        ///
        var bg = new cc.Scale9Sprite('s_sp9_13.png')
        bg.width = sideWidth
        ...
        {
            var id = itemIds[i]
            var itemBtnNode = menuSide.getItemBtnNode(id)
            itemBtnNode.setPositionY( sideHeight - menuSide.itemHight*(i+1) )
            menuSideNode.addChild(itemBtnNode)
    ...
    onTouchItem:function(itemId)
    {
        switch(itemId)
        {
            ...
            {
                menuSide.menuSideNode.setVisible(false)    
                menuSide.itemNodes[3].setVisible(true)
                break
            }
            case 4:
            {
                menuSide.menuSideNode.setVisible(false)    
                menuSide.itemNodes[4].setVisible(true)
                break
            }
            case 5:
            {   
