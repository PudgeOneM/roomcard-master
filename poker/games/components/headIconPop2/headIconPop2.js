...
var headIconPop2 = headIconPop = 
{
    kickUserPoolOnGameEnd:[],
    resp:'components/headIconPop2/res/',
    preLoadRes:
    [
    'components/headIconPop2/res/headIconPop.plist', 
    'components/headIconPop2/res/headIconPop.png',
    'components/headIconPop2/res/animationItem.plist', 
    'components/headIconPop2/res/animationItem.png',
    'components/headIconPop2/res/circle00.png',
    'components/headIconPop2/res/circle01.png',
    ],
    ...
    {   
        ...
        var node  = cc.BuilderReader.load('components/headIconPop2/res/headIconPop.ccbi', control)
        ...
        {   
            ...
            if(isTouchEnable)
                var itemIconBtn = new ccui.Button(resp_p['item'+i], resp_p['item'+i+'_gray'])
            else
                var itemIconBtn = new ccui.Button(resp_p['item'+i+'_gray'], resp_p['item'+i+'_gray'])
        ...
        var l = cc.EventListener.create({
            ...
            {   
                ...
                var spr = new cc.Sprite(resp_p['item'+itemId])
                ...
                spr.runAction( cc.sequence(
                    ...
                    {
                        managerAudio.playEffect(resp + 'item' + itemId + '.mp3')
                    }),
                    anima) )
            }
        })
