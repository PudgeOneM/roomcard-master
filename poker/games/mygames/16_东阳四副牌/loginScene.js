...
var loginScene = {
    ...
    login:function(d1,d2,d3)
    {
        ...
        //var sip = '192.168.2.254:20010'
        var rtid = 13
        //var sip = '192.168.2.117:20160'
        var sip = '47.116.210.98:9000' //测试
       // var sip = '192.168.2.254:20160'
        ...
        gameLog.log('----------------getTime--------------------:', Math.floor(new Date().getTime()/1000) + 36000)
