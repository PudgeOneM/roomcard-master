...
socket.sendMessage = function(mainCmdID,subCmdID,structObj)
{
    ...
    gameLog.log('c-s:' + mainCmdID + '(wMainCmdID)---' + subCmdID + '(wSubCmdID)---' + Math.ceil(new Date().getTime()/1000)+ '(time)---' )
    gameLog.log(mainCmdID + '(wMainCmdID)---' + subCmdID + '(wSubCmdID)---body:', structObj)
...
socket._onSocketMessage = function(msg)
{
    ...
    gameLog.log('s-c:' + head.CommandInfo.wMainCmdID + '(wMainCmdID)---' + head.CommandInfo.wSubCmdID + '(wSubCmdID)---' + Math.ceil(new Date().getTime()/1000)+ '(time)---' )
    gameLog.log(new Uint8Array(msg))
